...
function detail(){
	...
	var returnurl = "?m=system&s=money&a=tongji&keyword="+keyword+"&kehuName="+kehuName+"&areaId="+areaId+"&paystatus="+paystatus+"&level="+level+"&kehuStatus="+kehuStatus+"&startTime="+startTime+"&endTime="+endTime+"&page="+page+"&order1="+order1+"&order2="+order2;
	returnurl = encodeURIComponent(returnurl);
	var url = $("#url").val();
	location.href="?m=system&s=dinghuo&a=detail&id="+jiluId+"&returnurl="+returnurl+"&url="+url;
}
//获取当前选中的产品Id
function getPdtId(){
...
function daochu(){
	...
	$("#daochuA").attr("href",href+"&startTime="+startTime+"&endTime="+endTime+"&keyword="+keyword+"&kehuName="+kehuName+"&areaId="+areaId+"&paystatus="+paystatus+"&level="+level+"&kehuStatus="+kehuStatus);
}
//重新获取价格
function rerenderPrice(){
	...
	$.ajax({
        type: "POST",
        url: "?m=system&s=money&a=get_tongji_money",
        data: "startTime="+startTime+"&endTime="+endTime+"&keyword="+keyword+"&kehuName="+kehuName+"&areaId="+areaId+"&paystatus="+paystatus+"&level="+level+"&kehuStatus="+kehuStatus,
        dataType:"json",timeout : 30000,
        success: function(resdata){
            $("#price1").html(resdata.price1);
            $("#price2").html(resdata.price2);
            $("#price3").html(resdata.price3);
            $("#price4").html(resdata.price3);
            $("#price5").html(resdata.price3);
        },
        error: function() {
