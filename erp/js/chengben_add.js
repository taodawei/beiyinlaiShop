...
function selectRow(id,inventoryId,sn,title,key_vals,productId,units,kucun){
	...
	'<td bgcolor="#ffffff" class="sprukuadd_03_tt" align="center" valign="middle"><input type="text" placeholder="成本金额" lay-verify="required|number|kucun" name="inventoryChengben['+id+']" class="sprukuadd_03_tt_input">'+
