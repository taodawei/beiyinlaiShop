...
function selectType(suppId,id){
	...
	if(id==1){
		location.href='?m=system&s=supplier&a=orders&id='+suppId+'&startTime='+startTime+'&endTime='+endTime+'&url='+url;
	}else if(id==2){
		location.href='?m=system&s=supplier&a=orders2&id='+suppId+'&startTime='+startTime+'&endTime='+endTime+'&url='+url;
	}else{
		location.href='?m=system&s=supplier&a=orders3&id='+suppId+'&startTime='+startTime+'&endTime='+endTime+'&url='+url;
	}
}
//隐藏搜索框
...
function rerenderPrice(){
	...
	$.ajax({
        type: "POST",
        url: "/erp_service.php?action=get_supplier_huizong",
        data: "startTime="+startTime+"&endTime="+endTime+"&supplierId="+supplierId,
