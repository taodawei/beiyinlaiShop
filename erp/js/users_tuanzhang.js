...
function view(params){
	...
	var url = "?m=system&s=users&a=tuanzhang&level="+level+"&mendianId="+mendianId+"&keyword="+keyword+"&money_start="+money_start+"&money_end="+money_end+"&jifen_start="+jifen_start+"&jifen_end="+jifen_end+"&dtTime_start="+dtTime_start+"&dtTime_end="+dtTime_end+"&login_start="+login_start+"&login_end="+login_end+"&page="+page+"&order1="+order1+"&order2="+order2;
	url = encodeURIComponent(url);
	location.href="?m=system&s=users&a=tuanzhang_info&id="+pdtId+"&returnurl="+url;
}
...
function jin_user(){
	...
	$.ajax({
		type: "POST",
		url: "?m=system&s=users&a=jin_tuanzhang",
		data: "&id="+userId,
		dataType:"json",timeout : 8000,
		success: function(resdata){
			layer.closeAll('loading');
...
function qiyong_user(){
	...
	$.ajax({
		type: "POST",
		url: "?m=system&s=users&a=qi_tuanzhang",
		data: "&id="+userId,
		dataType:"json",timeout : 8000,
		success: function(resdata){
			layer.closeAll('loading');
