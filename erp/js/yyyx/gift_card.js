...
function daochu(){
	pdtId = getPdtId();
	$("#daochu").attr("href",$("#daochu").attr("href")+"&id="+pdtId);
}
//显示右侧点击。。。的弹窗
...
function view(params){
	...
	var url = "?s=yyyx&a=gift_card&type="+type+"&page="+page+"&order1="+order1+"&order2="+order2;
	url = encodeURIComponent(url);
	location.href="?s=yyyx&a=viewGiftCardJilu&id="+pdtId+"&returnurl="+url;
}
function zuofei(){
	pdtId = getPdtId();
	layer.load();
