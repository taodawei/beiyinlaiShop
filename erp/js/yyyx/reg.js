...
function piliang_zuofei(){
	...
	layer.confirm('确定要作废选中的活动吗？', {
		...
		ajaxpost=$.ajax({
			type: "POST",
			url: "?s=yyyx&a=piliang_zuofei_reg",
			data: "&ids="+ids,
...
function copy(){
	...
	var url = "?s=yyyx&a=reg&status="+status+"&page="+page+"&order1="+order1+"&order2="+order2;
	url = encodeURIComponent(url);
	location.href="?s=yyyx&a=create_reg&id="+getPdtId()+"&returnurl="+url;
}
