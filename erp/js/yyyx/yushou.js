...
function view(){
	...
	//var url = "?s=yyyx&a=cuxiao&status="+status+"&scene="+scene+"&startTime="+startTime+"&keyword="+keyword+"&endTime="+endTime+"&pdtName="+pdtName+"&mendianIds="+mendianIds+"&page="+page+"&order1="+order1+"&order2="+order2;
	//url = encodeURIComponent(url);
	//location.href="?s=yyyx&a=view_cuxiao&id="+getPdtId()+"&returnurl="+url;
}
...
function view_jilu(jiluId){
	...
	var order1 = $("#order1").val();
	var order2 = $("#order2").val();
	var url = nowpage+"&status="+status+"&type="+type+"&keyword="+keyword+"&startTime="+startTime+"&endTime="+endTime+"&page="+page+"&order1="+order1+"&order2="+order2;
	url = encodeURIComponent(url);
	location.href="?s=order&a=yushou_order&id="+jiluId+"&returnurl="+url;
}
function view_fahuo(jiluId){
	if(typeof(jiluId)=='undefined'){
		jiluId = getPdtId();
	}
	var status = $("#status").val();
	...
	var url = nowpage+"&status="+status+"&type="+type+"&keyword="+keyword+"&startTime="+startTime+"&endTime="+endTime+"&page="+page+"&order1="+order1+"&order2="+order2;
	url = encodeURIComponent(url);
	location.href="?s=yushou&a=index&yushouId="+jiluId+"&returnurl="+url;
}