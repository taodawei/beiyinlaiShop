...
function view(){
	...
	var url = "?s=yyyx&a=order&status="+status+"&scene="+scene+"&startTime="+startTime+"&keyword="+keyword+"&endTime="+endTime+"&pdtName="+pdtName+"&mendianIds="+mendianIds+"&page="+page+"&order1="+order1+"&order2="+order2;
	url = encodeURIComponent(url);
	location.href="?s=yyyx&a=view_order&id="+getPdtId()+"&returnurl="+url;
}
function copy(){
	var status = $("#status").val();
	var scene = $("#scene").val();
	...
	var url = "?s=yyyx&a=order&status="+status+"&scene="+scene+"&startTime="+startTime+"&keyword="+keyword+"&endTime="+endTime+"&pdtName="+pdtName+"&mendianIds="+mendianIds+"&page="+page+"&order1="+order1+"&order2="+order2;
	url = encodeURIComponent(url);
	location.href="?s=yyyx&a=create_order&id="+getPdtId()+"&returnurl="+url;
}
...
function view_jilu(jiluId){
	...
	var url = "?s=yyyx&a=order&status="+status+"&scene="+scene+"&startTime="+startTime+"&keyword="+keyword+"&endTime="+endTime+"&pdtName="+pdtName+"&mendianIds="+mendianIds+"&page="+page+"&order1="+order1+"&order2="+order2;
	url = encodeURIComponent(url);
	location.href="?s=yyyx&a=view_order&id="+jiluId+"&returnurl="+url;
}