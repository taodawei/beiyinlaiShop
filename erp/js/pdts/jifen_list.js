...
//删除单个产品
function del_jifen(params){
	var pdtId = getPdtId();
	layer.load();
	ajaxpost=$.ajax({
		type: "POST",
		url: "?m=system&s=product&a=del_jifen",
		data: "&id="+pdtId,
...
function view(){
	...
	var url = "?m=system&s=product&a=jifen&page="+page+"&order1="+order1+"&order2="+order2;
	url = encodeURIComponent(url);
	location.href="?m=system&s=product&a=create_jifen&id="+getPdtId()+"&url="+url;
}
