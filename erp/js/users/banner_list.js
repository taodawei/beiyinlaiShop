...
function del_gonggao(params){
	...
	ajaxpost=$.ajax({
		type: "POST",
		url: "?m=system&s=banner&a=delGongao",
		data: "&id="+pdtId,
...
function view(){
	...
	var url = "?m=system&s=banner&a=gonggao&channelId="+channelId+"&startTime="+startTime+"&keyword="+keyword+"&endTime="+endTime+"&page="+page+"&order1="+order1+"&order2="+order2;
	url = encodeURIComponent(url);
	location.href="?m=system&s=banner&a=addGonggao&id="+getPdtId()+"&url="+url;
}
