...
function selectRow(id,inventoryId,sn,title,key_vals,productId,units,kucun,num=''){
	...
	'<td bgcolor="#ffffff" width="175" class="sprukuadd_03_tt" align="center" valign="middle">'+
		'<input type="text" lay-verify="required|number|kucun" name="inventoryNum['+id+']" id="ruku_num_'+inventoryId+'" value="'+num+'" onfocus="showTips(this,\''+kucun+'\');" max="'+kucun+'" class="sprukuadd_03_tt_input">'+
