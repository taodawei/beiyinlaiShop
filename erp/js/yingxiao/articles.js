...
function del_gonggao(params){
	...
	ajaxpost=$.ajax({
		type: "POST",
		url: "?m=system&s=yingxiao&a=delArticle",
		data: "&id="+pdtId,
...
function view(){
	...
	var url = "?m=system&s=yingxiao&a=articles&pid="+pid+"&channelId="+channelId+"&startTime="+startTime+"&keyword="+keyword+"&endTime="+endTime+"&page="+page+"&order1="+order1+"&order2="+order2;
	url = encodeURIComponent(url);
	location.href="?m=system&s=yingxiao&a=addArticle&id="+getPdtId()+"&pid="+pid+"&url="+url;
}
