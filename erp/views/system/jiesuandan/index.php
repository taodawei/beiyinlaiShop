...
<body>
	<div class="right_up">
		<img src="images/biao_94.png"/> 结算单列表（<font color="red">PS：导出结算单前请先进行发货操作</font>）
	</div>
				...
				<div class="splist_up_01">
					...
					<div class="splist_up_01_right">
						<div class="splist_up_01_right_3">
							<a href="?s=jiesuandan&a=daochu" id="daochuB" onclick="daochu1();" class="splist_add">导 出</a>
							<a href="?s=jiesuandan&a=prints" id="daochuA" onclick="daochu();" class="splist_add">打 印</a>
						</div>
						<div class="clearBoth"></div>
					</div>
					<div class="clearBoth"></div>
	...
	<script type="text/javascript" src="js/fahuo/jiesuandan.js"></script>
