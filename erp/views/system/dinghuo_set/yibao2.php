...
<body>
	<div class="spshezhi">
		<div class="spshezhi_1">
			<img src="images/biao_35.png"> 个体工商户注册
		</div>
		<div>
			<form method="post" action="/yop-api/sendIndividualreginfoadd.php" targe="_blank" class="layui-form">
			<table width="700" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left:20px;">
				...
				<tr>
					...
					<td align="left">
						...
						&nbsp;<span style="color:#FF0000;font-weight:100;">1M以内</span>
						<input type="hidden" id="CORP_CODE" name="CORP_CODE" lay-verify="required">
					</td>
				</tr>
				<tr>
