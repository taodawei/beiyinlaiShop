...
$gonggao = null;
if(!empty($id)){
    $gonggao = $db->get_row("select * from demo_product_think where id=$id ");
}

$roles = $db->get_results("select * from demo_product_topic where is_del = 0 order by ordering desc ");
...
<head>
    ...
    <style>
	    .yx_guanggaoadd_01_right_input{color:black}
		.layui-table-view{margin:10px;}
	</style>
</head>
<body>
    <div class="right_up">
        <a href="javascript:history.go(-1);"><img src="images/biao_63.png"/></a> 新增专题思路
    </div>
    <div class="right_down">
        <div class="yx_guanggaoadd">
            <form method="post" action="?m=system&s=topic&a=addThink&submit=1&id=<?=$id?>" class="layui-form">
                ...
                <ul>
                    <li>
                        ...
                        <div class="yx_guanggaoadd_01_right">
                            <input type="text" name="title" value="<?=$gonggao->title?>" lay-verify="required" placeholder="请输入中文标题" class="yx_guanggaoadd_01_right_input"/>
                        </div>
                    ...
                    <li>
                        ...
                        <div class="yx_guanggaoadd_01_right">
                            <input type="text" name="en_title" value="<?=$gonggao->en_title?>" lay-verify="required" placeholder="请输入英文标题" class="yx_guanggaoadd_01_right_input"/>
                        </div>
                        <div class="clearBoth"></div>
                    </li>
                     ...
                     <li>
                        ...
                        <div class="yx_guanggaoadd_01_right" style="width:310px;">
                            <select name="topicId">
                                ...
                                ?>
                                <option value="<?=$list->id?>" <?=$list->id==$gonggao->topicId?'selected':''?>><?=$list->title?></option>
                                <?}?>
                            </select>
                        </div>
                        <div class="clearBoth"></div>
                   ...
                   <li style="display:none;">
                    ...
                    <li>
                        ...
                        <div class="yx_guanggaoadd_01_right">
                            <input type="text" name="download" value="<?=$gonggao->download?>"  placeholder="请输入下载的附件链接" class="yx_guanggaoadd_01_right_input"/>
                        </div>
                        <div class="clearBoth"></div>
                    </li>  
                    ...
                    <li>
                        ...
                        <div class="yx_guanggaoadd_01_right">
                            <?php
                            ewebeditor(EDITORSTYLE,'en_content',$gonggao->en_content,'800');
                            ?>
                        </div>
                        <div class="clearBoth"></div>
                    </li>
