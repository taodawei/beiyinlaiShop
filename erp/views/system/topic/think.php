...
$allRows = array(
	...
	"topic"=>array("title"=>"专题","rowCode"=>"{field:'topic',title:'专题',width:150}"),
...
$channels = $db->get_results("select * from demo_product_topic where is_del = 0 order by ordering desc ");
				...
				<div class="splist_up_01">
					...
					<div class="splist_up_01_right">
						...
						<div class="splist_up_01_right_3">
						    <? chekurl($arr,'<a href="?m=system&s=topic&a=addThink" class="splist_add">新 增</a>') ?>
						</div>
						<div class="clearBoth"></div>
					</div>
					<div class="clearBoth"></div>
	...
	<script type="text/javascript">
		...
		layui.use(['laydate', 'laypage','table','form','upload'], function(){
		  ...
		  productListTalbe = table.render({
		    elem: '#product_list'
		    ,height: "full-140"
		    ,url: '?m=system&s=topic&a=getThinkList'
		    ,page: {curr:<?=$page?>}
		    ,limit:<?=$limit?>
		    ,cols: [[<?=$rowsJS?>]]
		    ,where:{
        ...
        function editStudy(){
        	...
        	location.href="?m=system&s=topic&a=addThink&id="+getPdtId()+"&url="+url;
        }
