...
$gonggao = null;
if(!empty($id)){
    $gonggao = $db->get_row("select * from demo_product_topic where id=$id ");
}
...
<body>
    <div class="right_up">
        <a href="javascript:history.go(-1);"><img src="images/biao_63.png"/></a> 新增产品专题
    </div>
    <div class="right_down">
        <div class="yx_guanggaoadd">
            <form method="post" action="?m=system&s=topic&a=add&submit=1&id=<?=$id?>" class="layui-form">
