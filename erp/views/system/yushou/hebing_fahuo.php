...
//计算各类型订单的数量
$num_sql = "select status,count(*) as num from order_fahuo$fenbiao where mendianId=$mendianId and is_hebing=1 and comId=$comId and status<>3";
