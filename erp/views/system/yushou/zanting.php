...
$num_sql = "select count(*) as num from order_fahuo$fenbiao where comId=$comId and status=-2 and yushouId=$yushouId";
		...
		<div class="splist">
			<div class="splist_up" style="height:118px;">
				<div class="splist_up_addtab">
	            	<ul>
	            		<li>
	                    	<a href="?s=yushou&a=zanting&yushouId=<?=$request['yushouId']?>" class="splist_up_addtab_on">全部(<?=$zongNum?>)</a>
	                    </li>
...
<script type="text/javascript">
	...
	layui.use(['laydate', 'laypage','table','form'], function(){
	  ...
	  productListTalbe = table.render({
	    elem: '#product_list'
	    ,height: "full-200"
	    ,url: '?s=fahuo&a=getList&print_type=-2&yushouId=<?=$yushouId?>'
	    ,page: {curr:<?=$page?>}
	    ,limit:<?=$limit?>
	    ,cols: [[<?=$rowsJS?>]]
	    ,where:{
