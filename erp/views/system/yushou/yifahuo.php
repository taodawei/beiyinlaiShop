        ...
        <div class="splist">
            <div class="splist_up" style="height:118px;">
                <div class="splist_up_addtab">
                    <ul>
                        <li>
                            <a href="?s=yushou&type=0&a=yifahuo&yushouId=<?=$request['yushouId']?>" <? if($type==0){?>class="splist_up_addtab_on"<? }?>>待配货(<?=(int)$numArry[0]?>)</a>
                        </li>
                        <li>
                            <a href="?s=yushou&type=1&a=yifahuo&yushouId=<?=$request['yushouId']?>" <? if($type==1){?>class="splist_up_addtab_on"<? }?>>已配货(<?=(int)$numArry[1]?>)</a>
                        </li>
