...
$allRows = array(
    ...
    "beizhu"=>array("title"=>"撤销原因","rowCode"=>"{field:'beizhu',title:'撤销原因',width:228}")
);
...
$num_sql = "select kuaidi_type,count(*) as num from order_fahuo$fenbiao where comId=$comId and status=-1 and yushouId=$yushouId";
        ...
        <div class="splist">
            <div class="splist_up" style="height:118px;">
                <div class="splist_up_addtab">
                    <ul>
                        <li>
                            <a href="?s=yushou&a=chexiao&yushouId=<?=$request['yushouId']?>" <? if(empty($type)){?>class="splist_up_addtab_on"<? }?>>全部(<?=$zongNum?>)</a>
                        </li>
...
<script type="text/javascript">
    ...
    layui.use(['laydate', 'laypage','table','form'], function(){
      ...
      productListTalbe = table.render({
        elem: '#product_list'
        ,height: "full-200"
        ,url: '?s=fahuo&a=getChexiaos&yushouId=<?=$yushouId?>'
        ,page: {curr:<?=$page?>}
        ,limit:<?=$limit?>
        ,cols: [[<?=$rowsJS?>]]
        ,where:{
