...
<div class="print_tc" style="display:none;">
    ...
    <div class="damx_genghuanwuliu">
        <div class="damx_genghuanwuliu_1">
            ...
            <div class="damx_genghuanwuliu_1_right" onclick="xiaoshi();">
...
<script type="text/javascript">
	...
	layui.use(['laydate', 'laypage','table','form'], function(){
	  ...
	  productListTalbe = table.render({
	    elem: '#product_list'
	    ,height: "full-200"
	    ,url: '?s=fahuo&a=get_daoru_list&yushouId=<?=$yushouId?>'
	    ,page: {curr:<?=$page?>}
	    ,limit:<?=$limit?>
	    ,cols: [[<?=$rowsJS?>]]
	    ,where:{
...
<script type="text/javascript" src="js/yushou/daoru_list.js"></script>
</body>
</html>