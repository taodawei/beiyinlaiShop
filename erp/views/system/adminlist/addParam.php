...
$caiwu = array();
if(!empty($id)){
    $kehu = $db->get_row("select * from demo_product_fields where id=$id ");
...
<body>
	<div class="back1">
        ...
        <div><? if(empty($kehu)){?>添加<? }else{ echo '修改';}?>商品参数</div>
    </div>
    <div class="cont">
        <form action="?s=adminlist&a=addParam&tijiao=1&id=<?=$id?>" method="post" id="submitForm" class="layui-form">
            ...
            <div class="provider_cont">
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                         <td class="provider_td">
                            <div class="cont_left_tt">
                                <span class="must">*</span>Excel列名称
                            </div>
                            <div class="cont_left_input1">
                                <input name="title" class="layui-input" type="text" value="<?=$kehu->title?>" lay-verify="required" placeholder="请输入字段名称"/>
                            </div>
                    ...
                    <tr style="display:none;">
                         <td class="provider_td">
                            ...
                            <div class="cont_left_input1">
								...
								<input type="hidden" name="channelId" id="channelId" value="<?=$kehu->channelId?>" >
                            </div>
                            <div class="clearBoth"></div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="provider_td">
                            <div class="cont_left_tt">
                                <span class="must">*</span>数据表字段
                            </div>
                            <div class="cont_left_input1">
                                <input name="field_title" class="layui-input" type="text" value="<?=$kehu->field_title?>" lay-verify="required" placeholder="数据表字段"/>
                            </div>
                            <div class="clearBoth"></div>
                        </td> 
                    </tr>  
                    ...
                    <tr>
                        <td class="provider_td">
                            <div class="cont_left_tt">
                                <span class="must">*</span>字段大小
                            </div>
                            <div class="cont_left_input1">
                                <input type="radio" name="type" value="0" title="Varchar" <? if(empty($kehu->type)){?>checked="checked"<? }?>>
                                <input type="radio" name="type" value="1" title="Text" <? if($kehu->type==1){?>checked="checked"<? }?>>
                            </div>
                            <div class="clearBoth"></div>
                        </td> 
                    </tr>  
