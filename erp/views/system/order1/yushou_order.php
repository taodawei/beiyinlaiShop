...
$id = (int)$request['id'];
$yushou = $db->get_row("select * from yushou where id=$id and comId=10");
...
$numArry = array();
$num_sql = "select status,count(*) as num from order$fenbiao where yushouId=$id and comId=10 group by status";
