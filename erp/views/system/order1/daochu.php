...
$sql = "select id,orderId,userId,comId,mendianId,type,status,dtTime,remark,ispay,ifkaipiao,price,fahuo_json,shuohuo_json from order$fenbiao where comId=10 and (ispay=1 or type=2)";
if(!empty($status)){
