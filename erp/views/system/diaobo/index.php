...
$allRows = array(
				...
				"storeName"=>array("title"=>"调出仓库","rowCode"=>"{field:'storeName',title:'调出仓库',width:150}"),
				"store1Name"=>array("title"=>"调入仓库","rowCode"=>"{field:'store1Name',title:'调入仓库',width:150}"),
				"type_info"=>array("title"=>"出库类型","rowCode"=>"{field:'type_info',title:'出库类型',width:150}"),
...
$limit = empty($_COOKIE['diaoboPageNum'])?10:$_COOKIE['diaoboPageNum'];
...
<body>
	<div class="right_up">
		<img src="images/biao_58.png"/>商品调拨
	</div>
		...
		<div class="splist">
				...
				<div class="splist_up_01">
						...
						<div class="splist_up_01_left_02" style="margin-left:20px">
							...
							<div class="splist_up_01_left_02_down">
								<ul>
									...
									<li>
										<a href="javascript:" onclick="selectZt(2,'已调拨');">已调拨</a>
									</li>
									<li>
										<a href="javascript:" onclick="selectZt(1,'在途');">在途</a>
									</li>
									<li>
										<a href="javascript:" onclick="selectZt(-1,'已驳回');">已驳回</a>
									</li>
									<li>
										<a href="javascript:" onclick="selectZt(3,'待审批');">待审批</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="splist_up_01_right">
						<div class="splist_up_01_right_3">
                            <a href="?m=system&s=diaobo&a=add" class="splist_add">新 增</a>
						</div>
						<div class="clearBoth"></div>
					</div>
					<div class="clearBoth"></div>
			...
			<div class="splist_down1">
				...
				<div class="yuandian_xx" id="operate_row" data-id="0">
					<ul>
						<li id="rukuButton">
							<a href="javascript:jilu_detail('diaobo');"><img src="images/biao_126.png"> 入库</a>
						</li>
						<li>
							<a href="javascript:jilu_detail('diaobo');"><img src="images/biao_30.png"> 明细</a>
						</li>
					</ul>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		layui.use(['laydate', 'laypage','table','form'], function(){
		  ...
		  productListTalbe = table.render({
		    elem: '#product_list'
		    ,height: "full-140"
		    ,url: '?m=system&s=diaobo&a=getJilus'
		    ,page: {curr:<?=$page?>}
		    ,limit:<?=$limit?>
		    ,cols: [[<?=$rowsJS?>]]
		    ,where:{
