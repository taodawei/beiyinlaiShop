...
<body>
	<div class="right_up">
		<img src="images/biao_131.png"/> 文献列表
	</div>
				...
				<div class="splist_up_01">
					...
					<div class="splist_up_01_right">
						...
						<div class="splist_up_01_right_3">
						    <? chekurl($arr,'<a href="?m=system&s=literature&a=addGonggao&source='.$source.'" class="splist_add">新 增</a>') ?>
	...
	<script type="text/javascript">
		...
		layui.use(['laydate', 'laypage','table','form','upload'], function(){
		  ...
		  productListTalbe = table.render({
		    elem: '#product_list'
		    ,height: "full-140"
		    ,url: '?m=system&s=literature&a=getGonggaos'
		    ,page: {curr:<?=$page?>}
		    ,limit:<?=$limit?>
		    ,cols: [[<?=$rowsJS?>]]
		    ,where:{
...
//选择分类
	...
	<script type="text/javascript" src="js/shezhi/literature_list.js"></script>
