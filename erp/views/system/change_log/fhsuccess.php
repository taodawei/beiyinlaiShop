...
$allRows = array(
    ...
    "pdt_info"=>array("title"=>"产品","rowCode"=>"{field:'pdt_info',title:'产品',width:200}"),
...
//计算各类型订单的数量
$num_sql = "select count(*) as num from kmd_change_log where (status = 1 or status = 4) ";
...
<div id="content">
        ...
        <div class="splist">
            <div class="splist_up" style="height:118px;">
                <div class="splist_up_addtab">
                    <ul>
                        <li>
                            <a href="?s=change_log&a=fhsuccess" <? if(empty($type)){?>class="splist_up_addtab_on"<? }?>>全部(<?=$zongNum?>)</a>
                        </li>
                        <!--<li>-->
                        <!--    <a href="?s=fahuo&type=1&a=fhsuccess" <? if($type==1){?>class="splist_up_addtab_on"<? }?>>普通发货(<?=(int)$numArry[1]?>)</a>-->
                        <!--</li>-->
                        <!--<li>-->
                        <!--    <a href="?s=fahuo&type=2&a=fhsuccess" <? if($type==2){?>class="splist_up_addtab_on"<? }?>>电子面单发货(<?=(int)$numArry[2]?>)</a>-->
                        <!--</li>-->
                    ...
                    <div class="splist_up_01_right">
                        <div class="splist_up_01_right_1">
                            <div class="splist_up_01_right_1_left">
                                <input type="text" id="keyword" value="<?=$keyword?>" placeholder="发货单号/收货人信息/商品名称/快递单号"/>
                            </div>
                ...
                <div class="splist_up_02">
                    ...
                    <div class="splist_up_02_3">
                        <? chekurl($arr,'<a href="javascript:" _href="?m=system&s=fahuo&a=printpl" onclick="pldayin();"><img src="images/biao_26.png"> 批量打印</a>') ?>
					</div>
                    <div class="clearBoth"></div>
                </div>
            </div>
    ...
    <div class="dqddxiangqing" id="dqddxiangqing" data-id="0" style="display:none;margin-left:140px;">
...
<script type="text/javascript">
    ...
    function pldayin(){
        ...
        window.open("?m=system&s=fahuo&a=printpl&ids="+ids,'_blank');
    }
    //验证表单
    ...
    layui.use(['laydate', 'laypage','table','form'], function(){
      ...
      productListTalbe = table.render({
        elem: '#product_list'
        ,height: "full-200"
        ,url: '?s=change_log&a=getfhsuccess'
        ,page: {curr:<?=$page?>}
        ,limit:<?=$limit?>
        ,cols: [[<?=$rowsJS?>]]
        ,where:{
...
<script type="text/javascript" src="js/change_log/dianzi_list.js"></script>
<script type="text/javascript" src="js/change_log/dianzi_info.js"></script>
