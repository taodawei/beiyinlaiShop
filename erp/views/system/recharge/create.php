...
<body>
	<form action="?m=system&s=recharge&a=create&tijiao=1" method="post" id="createPdtForm" class="layui-form" enctype="multipart/form-data">
		<div class="content_edit">
			<div class="edit_h">
				<a href="javascript:history.go(-1);"><img src="images/back.jpg" /></a>
				<span><?=$chang->title?> 批量生成充值卡</span>
			</div>
				...
				<div class="jichu_message">
					<ul>
						...
						<li>
							...
							<div class="gaojisousuo_right">
								<input type="number" class="layui-input" name="money" step="1"   value="" lay-verify="required" placeholder="请输入生成卡面值">
							</div>
						</li>
						<li>
							<div class="gaojisousuo_left">
