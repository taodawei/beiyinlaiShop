...
$allRows = array(
				...
				"product_type"=>array("title"=>"供货品类","rowCode"=>"{field:'product_type',title:'供货品类',width:130}"),
				"sale_fanwei"=>array("title"=>"销售城市","rowCode"=>"{field:'sale_fanwei',title:'销售城市',width:150}"),
...
<body>
	<div class="right_up">
		<img src="images/biao_94.png"/> 直供商家列表
	</div>
					...
					<div class="splist_up_01_left">
						<div class="splist_up_01_left_01">
							<div class="splist_up_01_left_02_up">
								<span>商家类型</span> <img src="images/biao_20.png"/>
							</div>
							<div class="splist_up_01_left_02_down">
								<ul style="border-left:0px">
									<li class="allsort_01">
										<a href="javascript:selectType('1,2','全部');">全部</a>
									</li>
									<li class="allsort_01">
										<a href="javascript:selectType('1','全国');">全国</a>
									</li>
									<li class="allsort_01">
										<a href="javascript:selectType('2','同城');">同城</a>
									</li>
								</ul>
							</div>
						</div>
			...
			<div class="splist_down1">
				...
				<div class="yuandian_xx" id="operate_row" data-id="0">
					<ul>
						...
						<li class="btn_qiyong">
							<a href="javascript:" onclick="caigous();"><img src="images/shangchengdd_25.png"> 商品采购</a>
						</li>
						<li id="btn_jinyong">
