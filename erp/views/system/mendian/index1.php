...
<body>
	<div class="right_up">
		<img src="images/biao_94.png"/> 直发商家列表
	</div>
						...
						<div class="splist_up_01_left_01">
							...
							<div class="splist_up_01_left_02_down">
								<ul style="border-left:0px">
									<li class="allsort_01">
										<a href="javascript:selectType('3,4','全部');">全部</a>
									</li>
									<li class="allsort_01">
										<a href="javascript:selectType('3','自定价');">自定价</a>
									</li>
									<li class="allsort_01">
										<a href="javascript:selectType('4','平台定价');">平台定价</a>
									</li>
								</ul>
							</div>
						</div>
			...
			<div class="splist_down1">
				...
				<div class="yuandian_xx" id="operate_row" data-id="0">
					<ul>
						...
						<li>
							<a href="javascript:mendian_pdt();"><img src="images/shangpin.png"> 商家商品</a>
						</li>
						<li class="btn_qiyong">
