...
$id = (int)$request['id'];
if(!empty($id))$mendian=$db->get_row("select title,money from mendian where id=$id");
?>
<!doctype html>
<html>
<head>
...
<body>
    <div class="mendianguanli"> 
        <div class="mendianguanli_up">
            <a href="javascript:" onclick="history.go(-1);"><img src="images/users_39.png"></a> <b style="color:#369dd0;"><?=$user->nickname?></b> 商家充值
        </div>
        <div class="mendianguanli_down">
            <div class="huiyuanchongzhi">
                ...
                <div class="huiyuanchongzhi_2">
                    <form method="post" id="chongzhiForm" action="?s=mendian&a=chongzhi" class="layui-form">
    ...
    <script type="text/javascript">
        layui.use(['form'], function(){
            ...
            form.on('submit(tijiao)', function(data){
                ...
                $.ajax({
                    type: "POST",
                    url: '?s=mendian&a=chongzhi&submit=1',
                    data: data.field,
