...
<head>
	...
	<script type="text/javascript" src="js/recruit_channel.js?v=1"></script>
</head>
<body>
	<div class="jiliangdanwei">
		<div class="jiliangdanwei_up">
			...
			<div class="jiliangdanwei_up_right">
			    <? chekurl($arr,'<a href="javascript:" _href="?m=system&s=recruit_channel&a=addProductChannel" onclick="edit_channel(0,0,\'\',\'\',\'\',0,\'\');">+ 新 增</a>') ?>
			</div>
						...
						<li data-id="<?=$c->id?>" data-pid="0">
							<div class="shangpinguanli_01">
								...
								<div class="shangpinguanli_01_right">
									...
									<? chekurl($arr,'<a href="javascript:" _href="?m=system&s=recruit_channel&a=addProductChannel" onclick="edit_channel('.$c->id.',0,\''.$c->title.'\',\''.$c->en_title.'\',\''.$c->originalPic.'\',\''.$c->backimg.'\',\''.$c->is_hot.'\',\''.$c->type.'\',\''.$c->remark.'\');"><img src="images/biao_49.png"/> 修改</a>') ?>
