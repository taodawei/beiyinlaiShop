...
$allRows = array(
                ...
                "dtTime"=>array("title"=>"入库日期","rowCode"=>"{field:'dtTime',title:'入库日期',width:150,sort:true}"),
                "storeName"=>array("title"=>"所属仓库","rowCode"=>"{field:'storeName',title:'所属仓库',width:150}"),
                "type_info"=>array("title"=>"入库类型","rowCode"=>"{field:'type_info',title:'入库类型',width:150}"),
...
$limit = empty($_COOKIE['chengbenPageNum'])?10:$_COOKIE['chengbenPageNum'];
...
<body>
    <div class="right_up">
        <img src="images/biao_84.png"/>成本调整
    </div>
        ...
        <div class="splist">
                ...
                <div class="splist_up_01">
                    ...
                    <div class="splist_up_01_right">
                        <div class="splist_up_01_right_3">
                            <a href="?m=system&s=chengben&a=daoru" class="splist_daoru">导 入</a>
                            <a href="?m=system&s=chengben&a=add" class="splist_add">新 增</a>
                        </div>
                        <div class="clearBoth"></div>
                    </div>
                    <div class="clearBoth"></div>
            ...
            <div class="splist_down1">
                ...
                <div class="yuandian_xx" id="operate_row" data-id="0">
                    <ul>
                        <li>
                            <a href="javascript:jilu_detail('chengben');"><img src="images/biao_30.png"> 明细</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        layui.use(['laydate', 'laypage','table','form'], function(){
          ...
          productListTalbe = table.render({
            elem: '#product_list'
            ,height: "full-140"
            ,url: '?m=system&s=chengben&a=getJilus'
            ,page: {curr:<?=$page?>}
            ,limit:<?=$limit?>
            ,cols: [[<?=$rowsJS?>]]
            ,where:{
