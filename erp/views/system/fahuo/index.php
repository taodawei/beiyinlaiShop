...
//计算各类型订单的数量
$num_sql = "select status,count(*) as num from order_fahuo$fenbiao where comId=$comId  and status>-1 and (status=0 or kuaidi_type=2)";
        ...
        <div class="splist">
            <div class="splist_up" style="height:118px;">
                <div class="splist_up_addtab">
                    <ul>
                        <li>
                            <a href="?s=fahuo&type=0&scene=<?=$scene?>" <? if(empty($type)){?>class="splist_up_addtab_on"<? }?>>全部(<?=$zongNum?>)</a>
                        </li>
                        <li>
                            <a href="?s=fahuo&type=1&scene=<?=$scene?>" <? if($type==1){?>class="splist_up_addtab_on"<? }?>>待打印(<?=(int)$numArry[0]?>)</a>
                        </li>
                        <li>
                            <a href="?s=fahuo&type=2&scene=<?=$scene?>" <? if($type==2){?>class="splist_up_addtab_on"<? }?>>待确认(<?=(int)$numArry[1]?>)</a>
                        </li>
                        <li>
                            <a href="?s=fahuo&type=3&scene=<?=$scene?>" <? if($type==3){?>class="splist_up_addtab_on"<? }?>>已确认(<?=(int)$numArry[3]?>)</a>
                        </li>
