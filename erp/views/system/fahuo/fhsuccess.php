...
//计算各类型订单的数量
$num_sql = "select kuaidi_type,count(*) as num from order_fahuo$fenbiao where comId=$comId and status=3";
        ...
        <div class="splist">
            <div class="splist_up" style="height:118px;">
                <div class="splist_up_addtab">
                    <ul>
                        <li>
                            <a href="?s=fahuo&a=fhsuccess" <? if(empty($type)){?>class="splist_up_addtab_on"<? }?>>全部(<?=$zongNum?>)</a>
                        </li>
                        <!--<li>-->
...
<script type="text/javascript" src="js/fahuo/dianzi_list.js"></script>
