...
header("Content-Disposition:attachment; filename=出库单-$fahuoTime.xls");
$allRows = array(
...
$sql = "select userId,orderId,productId,pdtInfo,num from order_detail$fenbiao where orderId in($orderIds)";
