...
$allRows = array(
	"date"=>array("title"=>"日期","rowCode"=>"{field:'date',title:'日期',width:200}"),
	...
	"caozuo"=>array("title"=>"时间段订单","rowCode"=>"{field:'caozuo',title:'时间段订单',width:250}")
);
...
<body>
	<div class="right_up">
		<img src="images/biao_19.png"/> 订单数量统计
	</div>
