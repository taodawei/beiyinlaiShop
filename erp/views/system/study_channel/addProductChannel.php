...
$occasionArr = [];
if(!empty($id)){
	$channel = $db->get_row("select * from demo_study_channel where comId=$comId and id = {$id}");
	if($channel->tags){
...
<body>
	<div class="jiliangdanwei">
		<div class="jiliangdanwei_up">
			...
			<div class="jiliangdanwei_up_right">
				<a href="?m=system&s=study_channel">列表</a>
			</div>
			<div class="clearBoth"></div>
		</div>
		<div class="shangpinguanli" style="padding-top:20px">
            <form action="?m=system&s=study_channel&a=addProductChannel&submit=1&id=<?=$id?>" class="layui-form" method="post">
                    ...
                    <div class="layui-form-item" style="margin-top: 30px;">
                        ...
                        <div class="layui-input-block">
                            ...
                            <a href="?m=system&s=study_channel" class="layui-btn layui-btn-primary">返回列表</a>
                        </div>
                    </div>
	...
	<script>
        layui.use(['form','upload'],function(){
            ...
            $.get("/erp_service.php?action=get_study_channels&id=<?=$id?>&pid=<?=$pid?>",function(res){
