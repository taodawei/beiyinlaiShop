            ...
            <div class="splist_up_01" style="position: static;">
                <div class="splist_up_01_right">
                    <div class="splist_up_01_right_1">
                        <form method="post" id="forms" action="?s=pdts_fahuo&a=putong_hebing">
                ...
                <div class="dangqiandd_3">
                    <div class="dqdd_kehebingdd">
                        <?
                            ...
                            $sql = "select addressId,group_concat(id) as fahuoIds,count(*) as num,sum(weight) as weight from order_fahuo0 where mendianId=$mendianId and status=0 and is_hebing=0 and if_yushou=0";
...
<script type="text/javascript">
    function quxiao_hebings(funs,num){
        $("#fun"+num).val(funs);
        $("#form"+num).submit();
    }
