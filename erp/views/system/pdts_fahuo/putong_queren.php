...
<div class="print_tc" style="display:none;">
    ...
    <div class="damx_genghuanwuliu">
        ...
        <div class="damx_genghuanwuliu_2" style="text-align: center;">
            <form id="pandianForm" action="?m=system&s=pdts_fahuo&a=daochuOrder" method="post" target="_blank">
...
<script type="text/javascript">
	...
	layui.use(['laydate', 'laypage','table','form'], function(){
	  ...
	  productListTalbe = table.render({
	    elem: '#product_list'
	    ,height: "full-200"
	    ,url: '?s=pdts_fahuo&a=get_daoru_list'
	    ,page: {curr:<?=$page?>}
	    ,limit:<?=$limit?>
	    ,cols: [[<?=$rowsJS?>]]
	    ,where:{
...
<script type="text/javascript" src="js/pdts_fahuo/daoru_list.js"></script>
</body>
</html>