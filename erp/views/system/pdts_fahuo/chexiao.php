...
//计算各类型订单的数量
$num_sql = "select kuaidi_type,count(*) as num from pdt_order_fahuo where comId=$comId and status=-1";
$title = '撤销发货';
$zongNum = 0;
$numArry = array();
        ...
        <div class="splist">
            <div class="splist_up" style="height:118px;">
                <div class="splist_up_addtab">
                    <ul>
                        <li>
                            <a href="?s=pdts_fahuo&a=chexiao" <? if(empty($type)){?>class="splist_up_addtab_on"<? }?>>全部(<?=$zongNum?>)</a>
                        </li>
...
<script type="text/javascript">
    ...
    layui.use(['laydate', 'laypage','table','form'], function(){
      ...
      productListTalbe = table.render({
        elem: '#product_list'
        ,height: "full-200"
        ,url: '?s=pdts_fahuo&a=getChexiaos'
        ,page: {curr:<?=$page?>}
        ,limit:<?=$limit?>
        ,cols: [[<?=$rowsJS?>]]
        ,where:{
