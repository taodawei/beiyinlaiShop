...
$allRows = array(
    ...
    "is_peihuo"=>array("title"=>"配货状态","rowCode"=>"{field:'is_peihuo',title:'配货状态',width:100}"),
    "peihuo_num"=>array("title"=>"配货单打印次数","rowCode"=>"{field:'peihuo_num',title:'配货单打印次数',width:130}"),
    ...
    "caozuo"=>array("title"=>"操作","rowCode"=>"{field:'caozuo',title:'操作',width:140}"),
);
...
//计算各类型订单的数量
$num_sql = "select count(*) as num,is_peihuo from fahuo_pici$fenbiao where comId=$comId and need_peihuo=1 group by is_peihuo";
$title = '配货';
$zongNum = 0;
$numArry = array();
//$num_sql.=" group by id";
        ...
        <div class="splist">
            <div class="splist_up" style="height:118px;">
                <div class="splist_up_addtab">
                    <ul>
                        <li>
                            <a href="?s=pdts_fahuo&type=0&a=yifahuo" <? if($type==0){?>class="splist_up_addtab_on"<? }?>>待配货(<?=(int)$numArry[0]?>)</a>
                        </li>
                        <li>
                            <a href="?s=pdts_fahuo&type=1&a=yifahuo" <? if($type==1){?>class="splist_up_addtab_on"<? }?>>已配货(<?=(int)$numArry[1]?>)</a>
                        </li>
                ...
                <div class="splist_up_02">
                    ...
                    <div class="dangqiandd_2_down_3">
                        <a href="javascript:;" onclick="piliang_wancheng();"><img src="images/miandan_1.png"/> 批量完成</a>
                    </div>
                    <? }?>
                    <div class="clearBoth"></div>
                </div>
...
function peihuo_wancheng(id){
    layer.confirm('确定已完成配货吗？', {
      btn: ['确定','取消'],
        ...
        ajaxpost=$.ajax({
            type: "POST",
            url: "?s=pdts_fahuo&a=peihuo_wancheng",
            data: "&ids="+id,
...
<script type="text/javascript" src="js/pdts_fahuo/fahuo_list.js"></script>
