        ...
        <div class="splist">
            <div class="splist_up" style="height:118px;">
                <div class="splist_up_addtab">
                    <ul>
                        <li>
                            <a href="?s=pdts_fahuo&type=0&a=pici" <? if($type==0){?>class="splist_up_addtab_on"<? }?>>全部(<?=$zongNum?>)</a>
                        </li>
                        <li>
                            <a href="?s=pdts_fahuo&type=1&a=pici" <? if($type==1){?>class="splist_up_addtab_on"<? }?>>普通发货(<?=(int)$numArry[1]?>)</a>
                        </li>
                        <li>
                            <a href="?s=pdts_fahuo&type=2&a=pici" <? if($type==2){?>class="splist_up_addtab_on"<? }?>>电子面单(<?=(int)$numArry[2]?>)</a>
                        </li>
...
<script type="text/javascript">
    ...
    layui.use(['laydate', 'laypage','table','form'], function(){
      ...
      productListTalbe = table.render({
        elem: '#product_list'
        ,height: "full-200"
        ,url: '?s=pdts_fahuo&a=getPiciLists'
        ,page: {curr:<?=$page?>}
        ,limit:<?=$limit?>
        ,cols: [[<?=$rowsJS?>]]
        ,where:{
