...
//计算各类型订单的数量
$num_sql = "select status,count(*) as num from pdt_order_fahuo where mendianId=$mendianId and is_hebing=1 and comId=$comId and status<>3";
            ...
            <div class="splist_up" style="height:118px;">
                <div class="splist_up_addtab">
                    <ul>
                        ...
                        <li style="display: none;">
                            <a href="?s=pdts_fahuo&type=2&a=putong&scene=<?=$scene?>" <? if($type==2){?>class="splist_up_addtab_on"<? }?>>已导出(<?=(int)$numArry[1]?>)</a>
                        </li>
                    ...
                    <div class="splist_up_01_right">
                        <div class="splist_up_01_right_1">
                            <div class="splist_up_01_right_1_left">
                                <input type="text" id="keyword" value="<?=$keyword?>" placeholder="订单号"/>
                            </div>
                ...
                <div class="splist_up_02">
                    ...
                    <div class="dangqiandd_2_down_3">
                        <a href="javascript:;" id="print_fahuo"><img src="images/miandan_1.png" alt=""/> 打印发货单</a>
                    </div>
                    <div class="clearBoth"></div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    layui.use(['laydate', 'laypage','table','form'], function(){
      ...
      productListTalbe = table.render({
        elem: '#product_list'
        ,height: "full-200"
        ,url: '?s=pdts_fahuo&a=getHeBingLists'
        ,page: {curr:<?=$page?>}
        ,limit:<?=$limit?>
        ,cols: [[<?=$rowsJS?>]]
        ,where:{
    ...
    {
     for ( var i=0;i<document.getElementsByName("pro[]").length;i++ )
       {
         document.getElementsByName("pro[]")[i].checked = document.getElementsByName("chkAll")[0].checked;
        }
    }
</script>
