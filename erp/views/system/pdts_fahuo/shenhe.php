...
//计算各类型订单的数量
$num_sql = "select status,count(*) as num from pdt_order_fahuo where mendianId=$mendianId and status=0 and if_yushou=0";
...
<script type="text/javascript" src="js/pdts_fahuo/shenhe_list.js"></script>
