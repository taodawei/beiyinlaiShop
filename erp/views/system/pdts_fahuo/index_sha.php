...
//计算各类型订单的数量
$num_sql = "select status,count(*) as num from pdt_order_fahuo where comId=$comId and status<>3";
                    ...
                    <div class="splist_up_01_right">
                        <div class="splist_up_01_right_1">
                            <div class="splist_up_01_right_1_left">
                                <input type="text" id="keyword" value="<?=$keyword?>" placeholder="发货单号"/>
                            </div>
