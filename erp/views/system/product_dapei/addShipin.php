...
$originalPics = array();
if(!empty($request['id'])){
    $shipin = $db->get_row("select * from demo_product_dapei where id=".(int)$request['id']);
...
<body>
    ...
    <div class="right_down">
        <div class="yx_guanggaoadd">
            <form method="post" action="?m=system&s=product_dapei&a=addShipin&tijiao=1&id=<?=$shipin->id?>" class="layui-form">
                ...
                <ul>
                    <li>
                        ...
                        <div class="yx_guanggaoadd_01_right">
                            <input type="text" name="title" value="<?=$shipin->title?>" lay-verify="required" placeholder="请输入搭配标题" class="yx_guanggaoadd_01_right_input"/>
                        </div>
                        <div class="clearBoth"></div>
                    </li>
                    <li>
                        ...
                        <div class="yx_guanggaoadd_01_right">
                            <input type="text" name="remark" value="<?=$shipin->remark?>" maxlength placeholder="搭配标签" class="yx_guanggaoadd_01_right_input"/>
                        </div>
                        <div class="clearBoth"></div>
                    </li>
                    <li>
                        <div class="edit_photo" style="margin-left:50px;">
                            <div class="photo_tt" style="color:#333">
                                图片<span style="color:#9b9b9b">(说明：图片不超过1M)</span>
                            </div>
                            <div class="photo_tu">
                                <ul>
                                    <li id="uploadImages" data-num="1" style="position:relative;">
                                        <img src="<?=empty($shipin->originalPic)?'images/photo1.jpg':$shipin->originalPic?>" width="136" height="136" />
...
<script type="text/javascript" src="js/product_dapei/addShipin.js"></script>
</body>
</html>