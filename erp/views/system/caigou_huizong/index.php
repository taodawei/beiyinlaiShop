...
$limit = empty($_COOKIE['caigouhPageNum'])?10:$_COOKIE['caigouhPageNum'];
?>
<!doctype html>
<html>
<head>
        ...
        <div class="operate">
            <div class="splist_up_01_left_02">
                <div class="splist_up_01_left_01_up">
                    <span>按供应商</span> <img src="images/biao_20.png"/>
                </div>
            ...
            <div class="export">
                <a href="?m=system&s=caigou_huizong&a=daochuOrders1" onclick="daochu();" target="_blank" id="daochuA">导出</a>
            </div>
        </div>
        <div class="mun">
            <ul>
    ...
    <script type="text/javascript">
        ...
        layui.use(['laydate', 'laypage','table','form'], function(){
          ...
          productListTalbe = table.render({
            elem: '#product_list'
            ,height: "full-300"
            ,url: '?m=system&s=caigou_huizong&a=getOrders1&id=<?=$id?>'
            ,page: {curr:<?=$page?>}
            ,limit:<?=$limit?>
            ,cols: [[{field: 'title', title: '供应商名称', width:250},{field:'orderIds',title:'采购单总数',width:150,sort:true},{field:'nums',title:'采购商品数',width:150},{field:'price',title:'采购总金额',width:200}]]
            ,where:{
                startTime:'<?=$startTime?>',
                endTime:'<?=$endTime?>'
