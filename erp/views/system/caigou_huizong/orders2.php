...
$limit = empty($_COOKIE['caigouh2PageNum'])?10:$_COOKIE['caigouh2PageNum'];
?>
<!doctype html>
<html>
<head>
...
<body>
    ...
    <div class="cont">
        <div class="operate">
            ...
            <div class="export">
                <a href="?m=system&s=caigou_huizong&a=daochuOrders2" onclick="daochu();" target="_blank" id="daochuA">导出</a>
            </div>
        </div>
        <div class="mun">
            <ul>
    ...
    <script type="text/javascript">
        ...
        layui.use(['laydate', 'laypage','table','form'], function(){
          ...
          productListTalbe = table.render({
            elem: '#product_list'
            ,height: "full-300"
            ,url: '?m=system&s=caigou_huizong&a=getOrders2&id=<?=$id?>'
            ,page: {curr:<?=$page?>}
            ,limit:<?=$limit?>
            ,cols: [[{field:'dtTime',title:'采购时间',width:150,sort:true},{field: 'orderId', title: '采购单号', width:150},{field:'sn',title:'商品编码',width:150},{field:'title',title: '商品名称',width:250,style:"height:auto;line-height:22px;white-space:normal;"},{field: 'key_vals', title: '商品规格',width:250,style:"height:auto;line-height:22px;white-space:normal;"},{field:'num',title:'采购数量',width:90},{field:'units',title:'单位',width:90},{field:'price',title:'采购价',width:100},{field:'price_zong',title:'小计',width:100}]]
            ,where:{
                startTime:'<?=$startTime?>',
                endTime:'<?=$endTime?>'
