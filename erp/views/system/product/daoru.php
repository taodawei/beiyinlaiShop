...
<body>
	...
	<div class="right_down">
		<div class="splist_up_addtab">
        	<ul>
        		<li>
                	<a href="javascript:" class="splist_up_addtab_on">导入新增商品</a>
                </li>
                <li>
		...
		<form action="?m=system&s=product&a=daoru1" method="post" id="pandianForm" class="layui-form">
		<div class="kucunpandian">
			<div class="kucunpandian_01" style="height: 250px;">
				<ul>
				...
				<div class="clearBoth"></div>
			    <div style="display:inline-block;float:left;margin-left:40px;">注意事项：</div><div style="text-align:left;color:red;display:inline-block;vertical-align:top;float:left;">1.导入商品以商品编码为识别条件，所以不要修改商品的编码栏；<br>2.务必删掉不修改的商品记录<br>3.单次上传商品记录不要超过1000条<br>4.第一行说明内容不能删 <br>5.类目 筛选条件 货号 产品名称 货期 规格 价格 这几个固定字段必有且不能改变顺序</div>
			</div>
