...
<body>
	<div class="right_up">
		<img src="images/biao_94.png"/> 备货单列表（<font color="red">PS：导出备货单前请先进行发货操作</font>）
	</div>
				...
				<div class="splist_up_01">
					...
					<div class="splist_up_01_right">
						<div class="splist_up_01_right_3">
							<a href="?s=beihuodan&a=daochu" id="daochuA" onclick="daochu();" class="splist_add">导 出</a>
							<a href="?s=beihuodan&a=prints" id="daochuB" onclick="daochu1();" class="splist_add">打 印</a>
						</div>
						<div class="clearBoth"></div>
					</div>
					<div class="clearBoth"></div>
	...
	<script type="text/javascript" src="js/fahuo/beihuodan.js?v=1"></script>
