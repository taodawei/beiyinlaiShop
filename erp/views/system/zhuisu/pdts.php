...
$allRows = array(
				...
				"key_vals"=>array("title"=>"规格","rowCode"=>"{field:'key_vals',title:'规格',width:200}"),
...
<body>
				...
				<div class="splist_up_01">
					...
					<div class="splist_up_01_right">
						...
						<div class="splist_up_01_right_3">
							<a href="?m=system&s=zhuisu&a=editPdts" class="splist_add">新 增</a>
						</div>
						<div class="clearBoth"></div>
					</div>
					<div class="clearBoth"></div>
			...
			<div class="splist_down1">
				...
				<div class="yuandian_xx" id="operate_row" data-id="0">
					<ul>
						...
						<li>
							<a href="javascript:shangjia();"><img src="images/biao_31.png"> 上架</a>
						</li>
						<li>
							<a href="javascript:xiajia();"><img src="images/biao_31.png"> 下架</a>
						</li>
					</ul>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		layui.use(['laydate', 'laypage','table','form'], function(){
		  ...
		  productListTalbe = table.render({
		    elem: '#product_list'
		    ,height: "full-140"
		    ,url: '?m=system&s=zhuisu&a=getPdtList'
		    ,page: {curr:<?=$page?>}
		    ,limit:<?=$limit?>
		    ,cols: [[<?=$rowsJS?>]]
		    ,where:{
	...
	<script type="text/javascript" src="js/zhuisu/pdts_list.js"></script>
