    ...
    <div class="cont">
        <div class="operate">
            <div class="splist_up_01_left_02">
                <div class="splist_up_01_left_01_up">
                    <span>按明细</span> <img src="images/biao_20.png"/>
                </div>
            ...
            <div class="export">
                <a href="?m=system&s=supplier&a=daochuOrders2&id=<?=$id?>" onclick="daochu();" target="_blank" id="daochuA">导出</a>
            </div>
        </div>
        <div class="mun">
            <ul>
        ...
        <div class="purchase_list2" style="width:100%;position:relative;">
            ...
            <div class="yuandian_xx" id="operate_row" data-id="0">
                <ul>
                    <li>
                        <a href="javascript:detail('orders2');"><img src="images/biao_30.png"> 明细</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        layui.use(['laydate', 'laypage','table','form'], function(){
          ...
          productListTalbe = table.render({
            elem: '#product_list'
            ,height: "full-360"
            ,url: '?m=system&s=supplier&a=getOrders2&id=<?=$id?>'
            ,page: {curr:<?=$page?>}
            ,cols: [[{field: 'id', title: 'id', width:0, sort: true,style:"display:none;"},{field:'dtTime',title:'采购时间',width:150,sort:true},{field: 'orderId', title: '采购单号', width:150},{field:'sn',title:'商品编码',width:150},{field:'title',title: '商品名称',width:250,style:"height:auto;line-height:22px;white-space:normal;"},{field: 'key_vals', title: '商品规格',width:250,style:"height:auto;line-height:22px;white-space:normal;"},{field:'num',title:'采购数量',width:90},{field:'units',title:'单位',width:90},{field:'price',title:'采购价',width:100},{field:'price_zong',title:'小计',width:100},{field:'status',title:'状态',width:100},{fixed:'right',width:49,title:'',align:'center', toolbar: '#barDemo'}]]
            ,where:{
                startTime:'<?=$startTime?>',
                endTime:'<?=$endTime?>'
