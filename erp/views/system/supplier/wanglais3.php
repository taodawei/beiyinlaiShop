    ...
    <script type="text/javascript">
        ...
        layui.use(['laypage','table'], function(){
          ...
          productListTalbe = table.render({
            elem: '#product_list'
            ,height: "full-20"
            ,url: '?m=system&s=supplier&a=getWanglai1&price_type=2&id=<?=$id?>'
            ,page: {curr:<?=$page?>}
        ...
        function detail(action){
            ...
            var endTime = $("#endTime").val();
            var url = $("#url").val();
            var returnurl = "?m=system&s=supplier&a=wanglais&id=<?=$id?>&nowPage=3&startTime="+startTime+"&endTime="+endTime;
