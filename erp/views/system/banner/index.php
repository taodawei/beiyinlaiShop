...
<head>
	...
	<script type="text/javascript">
		function del_banner(id){
			layer.load();
			location.href='?m=system&s=banner&a=del_banner&channelId=0&id='+id;
		}
	</script>
</head>
<body>
	<div class="right_up">
    	<img src="images/biao_131.png"/> banner广告
    </div>
	<div class="right_down">
    	<div class="yx_guanggaofabu">
        	<div class="yx_guanggaofabu_01">
            	<div class="yx_guanggaofabu_01_left">
                	已发布了<?=$count?>个广告，还可以发布<span><?=20-$count?></span>个广告
                </div>
            	<div class="splist_up_01_right">                      
                    <div class="splist_up_01_right_3">
                        <a href="?m=system&s=banner&a=addBanner&channelId=0" <? if($count>=20){?>onclick="layer.msg('最多只能创建二十个banner！',{icon:5});return false;"<? }?> class="splist_add">新 增</a>
                    </div>
                    ...
                    if(!empty($banners)){
                    	foreach($banners as $banner){
                    		...
                    		<tr height="43">
                    			...
                    			<td bgcolor="#ffffff" class="yx_guanggaofabu_02_tt" align="left" valign="middle">
                    				<a href="?m=system&s=banner&a=topBanner&id=<?=$banner->id?>&channelId=0"><img src="images/biao_135.png"/> 置顶</a>
                    				<a href="?m=system&s=banner&a=addBanner&id=<?=$banner->id?>&channelId=0"><img src="images/biao_136.png"/> 修改</a>
