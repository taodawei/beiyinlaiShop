...
$limit = empty($_COOKIE['rukuPageNum'])?10:$_COOKIE['rukuPageNum'];
...
<body>
	<div class="right_up">
		<img src="images/biao_58.png"/>商品入库
	</div>
		...
		<div class="splist">
				...
				<div class="splist_up_01">
						...
						<div class="splist_up_01_left_02">
							...
							<div class="splist_up_01_left_02_down">
								<ul>
									...
									<? 
									$rukuTypes = explode(',',$rukuTypes);
									foreach($rukuTypes as $type1){?>
										<li>
					...
					<div class="splist_up_01_right">
						<div class="splist_up_01_right_3">
						    <? chekurl($arr,'<a href="?m=system&s=ruku&a=add" class="splist_add">新 增</a>') ?>
						</div>
						<div class="clearBoth"></div>
					</div>
					<div class="clearBoth"></div>
			...
			<div class="splist_down1">
				...
				<div class="yuandian_xx" id="operate_row" data-id="0">
					<ul>
					    <? chekurl($arr,'<li><a href="javascript:" _href="?m=system&s=kucun&a=jilu_detail" onclick="jilu_detail(\'ruku\')"><img src="images/biao_30.png"> 明细</a></li>') ?>
					</ul>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		layui.use(['laydate', 'laypage','table','form'], function(){
		  ...
		  productListTalbe = table.render({
		    elem: '#product_list'
		    ,height: "full-140"
		    ,url: '?m=system&s=ruku&a=getJilus'
		    ,page: {curr:<?=$page?>}
		    ,limit:<?=$limit?>
		    ,cols: [[<?=$rowsJS?>]]
		    ,where:{
