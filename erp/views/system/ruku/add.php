...
<body>
	<div class="right_up">
    	<a href="javascript:history.go(-1);"><img src="images/biao_63.png"/> 新增商品入库</a>
    </div>
	<div class="right_down">
    	<div class="sprukuadd">
    		<form id="addForm" action="?m=system&s=ruku&a=add&tijiao=1" method="post" class="layui-form">
        	...
        	<div class="sprukuadd_03">
            	<table width="100%" border="0" cellpadding="0" cellspacing="0" id="dataTable" rows="1">
                	<tr height="43">
                        ...
                        <td bgcolor="#7bc8ed" width="175" class="sprukuadd_03_title" align="center" valign="middle" onmouseover="tips(this,'总数量-折损数量',1);" onmouseout="hideTips();"> 
                        	入库数量
                        </td>
	...
	<script type="text/javascript" src="js/ruku_add.js?v=1.1"></script>
