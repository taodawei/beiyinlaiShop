...
<body>
	...
	<div class="right_down">
		<form action="?m=system&s=ruku&a=pandian1" method="post" id="pandianForm" class="layui-form">
		<div class="kucunpandian">
			...
			<div class="kucunpandian_02">
				...
				<div class="kucunpandian_02_1">
					...
					<div class="kucunpandian_02_1_down">
						...
						<div class="kucunpandian_shujuxiazai">
							<a href="?m=system&s=ruku&a=daochuPandian" id="daochuA" onclick="daochu();"><img src="images/biao_78.png"/> 下载商品库存数据</a>
						</div>
						<div class="clearBoth"></div>
					</div>
				</div>
				<div class="kucunpandian_02_1">
					<div class="kucunpandian_02_1_up">
						3、上传商品入库数据<span style="font-size:13px;color:#999">(上传前请删除不需要入库的产品)</span>
					</div>
					<div class="kucunpandian_02_1_down">
						<div style="width:200px;display:inline-block;">
							<select name="type_info" id="type_info">
								<option value="">选择入库类型</option>
								<? foreach($rukuTypes as $type){
									?>
						...
						<button type="button" class="layui-btn" id="uploadFile">上传入库数据文件</button>
