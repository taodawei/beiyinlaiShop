...
<body>
    <div class="right_up">
        <a href="?s=yyyx&a=cuxiao"><img src="images/back.gif"/></a> 新增商品促销
    </div>
     ...
     <div class="sprukuadd">
        <form id="addForm" action="" method="post" class="layui-form">
            ...
            <div class="dhd_adddinghuodan_1">
                <div class="dhd_adddinghuodan_1_left"><span>*</span> 促销主题：</div>
                <div class="dhd_adddinghuodan_1_right">
                    <div class="dhd_adddinghuodan_1_right_01">
                        <input type="text" name="title" lay-verify="required" value="<?=$cuxiao->title?>" class="layui-input" placeholder="输入促销主题">
                    </div>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" id="dataTable" rows="<?=empty($cuxiao->pdtIds)?'1':count(explode(',',$cuxiao->pdtIds))?> 1">
                    ...
                    <? }else{
                        ...
                        foreach ($pdtIds as $key => $pdtId){
                            ...
                            $xiangou_num = (int)$db->get_var("select num from cuxiao_pdt_xiangou where cuxiao_id=$cuxiao->id and inventoryId=$pdtId");
                            ?>
             ...
             <ul>
                <li>
                    ...
                    <div class="dhd_adddinghuodan_3_right">
                        <input type="radio" name="accordType" lay-filter="accord1" <? if(empty($cuxiao)||$cuxiao->accordType==1){?>checked="true"<? }?> value="1" title="按数量">
                        <input type="radio" name="accordType" lay-filter="accord2" <? if($cuxiao->accordType==2){?>checked="true"<? }?> value="2" title="按金额">
                        <input type="radio" name="accordType" lay-filter="accord3" <? if($cuxiao->accordType==3){?>checked="true"<? }?> value="3" title="秒杀">
                    </div>
                    <div class="clearBoth"></div>
                </li>
                <li id="rule_li">
