...
<body>
    <div class="mendianguanli"> 
        <div class="mendianguanli_up">
            <a href="<?=urldecode($request['returnurl'])?>"><img src="images/users_39.png" alt=""/></a> 新增生日券
        </div>
                                ...
                                <li>
                                    ...
                                    <div class="addshengriquan_left_03_right">
                                        <div class="addshengriquan_left_03_duixiang">
                                            <select name="endDays">
                                                <option value="1" <? if($yhq->endDays==1){?>selected="true"<? }?>>1天</option>
                                                <option value="3" <? if($yhq->endDays==3){?>selected="true"<? }?>>3天</option>
                                                <option value="7" <? if($yhq->endDays==7){?>selected="true"<? }?>>7天</option>
                                                <option value="30" <? if($yhq->endDays==30){?>selected="true"<? }?>>30天</option>
                                                <option value="60" <? if($yhq->endDays==60){?>selected="true"<? }?>>60天</option>
                                                <option value="90" <? if($yhq->endDays==90){?>selected="true"<? }?>>90天</option>
                                                <option value="180" <? if($yhq->endDays==180){?>selected="true"<? }?>>180天</option>
                                                <option value="365" <? if($yhq->endDays==365){?>selected="true"<? }?>>一年</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="clearBoth"></div>
