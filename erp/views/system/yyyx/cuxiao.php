...
$allRows = array(
	...
	"pdts"=>array("title"=>"商品","rowCode"=>"{field:'pdts',title:'商品',width:150}"),
...
<body>
				...
				<div class="splist_up_01">
					...
					<div class="splist_up_01_right">	
											...
											<ul>
												<li>
													...
													<div class="gaojisousuo_right">
														<input type="text" name="super_pdtName" value="<?=$pdtName?>" class="gaojisousuo_right_input" placeholder="请输入商品名称/编码"/>
													</div>
													<div class="gaojisousuo_left">
														下单时间
													</div>
						...
						<div class="splist_up_01_right_3">
							...
							<a href="?s=yyyx&a=create_cuxiao" class="splist_add">新 增</a>
						</div>
						<div class="clearBoth"></div>
					</div>
					<div class="clearBoth"></div>
	...
	<script type="text/javascript" src="js/yyyx/cuxiao.js"></script>
