...
<body>
		...
		<div class="splist">
				...
				<div class="splist_up_01">
					...
					<div class="splist_up_01_right">
						<div class="yx_cuxiaoshuoming">
                        	充值赠送说明 <img onmouseover="tips(this,'1、同一时间点只能有一条规则生效；<br>',3);" onmouseout="hideTips();" src="images/yingxiao_21.png" alt="">
                            <div class="yx_cuxiaoshuoming_tanchu" style="display: none;">
                            	
                        	</div>
                        </div>
						<div class="splist_up_01_right_3">
						    <? chekurl($arr,'<a href="?m=system&s=yyyx&a=create_chongzhi" class="splist_add">新 增</a>') ?>
						</div>
						<div class="clearBoth"></div>
					</div>
					<div class="clearBoth"></div>
			...
			<div class="splist_down1">
				...
				<div class="yuandian_xx" id="operate_row" data-id="0" style="width:100px;">
					<ul>
					    <? chekurl($arr,'<li id="zuofeibtn"><a href="javascript:" _href="?m=system&s=yyyx&a=piliang_zuofei_chongzhi" onclick="z_confirm(\'确定要作废该活动吗？\',zuofei,\'\')"><img src="images/yingxiao_23.png"> 作废</a></li>') ?>
					    
					    <? chekurl($arr,'<li><a href="javascript:" _href="?m=system&s=yyyx&a=chongzhi_del" onclick="z_confirm(\'确定要删除该充值活动吗？\',del_anli,\'\');"><img src="images/biao_32.png"> 删除</a></li>') ?>
					</ul>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		function del_anli(params){
        	...
        	ajaxpost=$.ajax({
        		type: "POST",
        		url: "?m=system&s=yyyx&a=chongzhi_del",
        		data: "&ids="+pdtId,
	...
	<script type="text/javascript" src="js/yyyx/chongzhi.js"></script>
