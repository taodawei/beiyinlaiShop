...
$allRows = array(
    ...
    "orderId"=>array("title"=>"订单号","rowCode"=>"{field:'orderId',title:'订单号',width:220}"),
    "title"=>array("title"=>"标题","rowCode"=>"{field:'title',title:'标题',width:200}"),
    "name"=>array("title"=>"购买人","rowCode"=>"{field:'name',title:'购买人',width:113}"),
    ...
    "dtTime"=>array("title"=>"下单时间","rowCode"=>"{field:'dtTime',title:'下单时间',width:159}"),
        ...
        <div class="splist">
            <div class="splist_up" style="height:118px;">
                <div class="splist_up_addtab">
                    <ul>
                        <li>
                            <a href="?s=order&a=cards&scene=<?=$scene?>" <? if(empty($type)){?>class="splist_up_addtab_on"<? }?>>全部</a>
                        </li>
                        <li>
                            <a href="?s=order&status=1&a=cards&scene=<?=$scene?>" <? if($type==1){?>class="splist_up_addtab_on"<? }?>>未使用</a>
                        </li>
                        <li>
                            <a href="?s=order&status=2&a=cards&scene=<?=$scene?>" <? if($type==1){?>class="splist_up_addtab_on"<? }?>>已转增</a>
                        </li>
                        <li>
                            <a href="?s=order&status=3&a=cards&scene=<?=$scene?>" <? if($type==2){?>class="splist_up_addtab_on"<? }?>>已使用</a>
                        </li>
                    ...
                    <div class="splist_up_01_right">
                        <div class="splist_up_01_right_1">
                            <div class="splist_up_01_right_1_left">
                                <input type="text" id="keyword" value="<?=$keyword?>" placeholder="订单号/商品名称"/>
                            </div>
...
<script type="text/javascript">
    ...
    layui.use(['laydate', 'laypage','table','form'], function(){
        ...
        productListTalbe = table.render({
            elem: '#product_list'
            ,height: "full-200"
            ,url: '?s=order&a=getCardsList&print_type=1'
            ,page: {curr:<?=$page?>}
            ,limit:<?=$limit?>
            ,cols: [[<?=$rowsJS?>]]
            ,where:{
