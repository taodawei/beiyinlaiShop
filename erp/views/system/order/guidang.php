...
$limit = empty($_COOKIE['guidangPageNum'])?10:$_COOKIE['guidangPageNum'];
?>
<!doctype html>
<html>
<head>
...
<div id="content">
	<div class="right_up">
		<img src="images/biao_109.png"/> 归档订单
	...
	<div class="dqddxiangqing" id="dqddxiangqing" data-id="0" style="display:none;">
		<div class="dqddxiangqing_up" id="orderInfoMenu">
			<ul>
				...
				<li>
					<a href="javascript:" id="orderInfoMenu2" onclick="qiehuan('orderInfo',2,'dqddxiangqing_up_on');order_error_index(0);">异常记录</a>
				</li>
				<li>
					<a href="javascript:" id="orderInfoMenu3" onclick="qiehuan('orderInfo',3,'dqddxiangqing_up_on');order_tuihuan_index(0);">退换货记录</a>
				</li>
				<li>
					<a href="javascript:" id="orderInfoMenu4" onclick="qiehuan('orderInfo',4,'dqddxiangqing_up_on');order_service_index(0);">订单服务记录</a>
				</li>
				<li>
...
<script type="text/javascript" src="js/order/order_guidang.js"></script>
