...
$allRows = array(
	...
	"shoupiao_phone"=>array("title"=>"收票人手机","rowCode"=>"{field:'shoupiao_phone',title:'收票人手机',width:150}"),
	"shoupiao_email"=>array("title"=>"收票人邮箱","rowCode"=>"{field:'shoupiao_email',title:'收票人邮箱',width:150}"),
...
<div id="content">
	<div class="right_up">
		<img src="images/biao_109.png"/> 发票管理
		...
		<div class="splist">
			<div class="splist_up">
				<div class="splist_up_01">
					<div class="splist_up_01_left">
						<div class="splist_up_01_left_02">
							<div class="splist_up_01_left_02_up">
								<span>全部</span> <img src="images/biao_20.png"/>
							</div>
							<div class="splist_up_01_left_02_down">
								<ul>
									<li>
										<a href="javascript:" onclick="selectkaipiao('0','全部');">全部</a>
									</li>
									<li>
										<a href="javascript:" onclick="selectkaipiao('1','待开票');">待开票</a>
									</li>
									<li>
										<a href="javascript:" onclick="selectkaipiao('2','已开票');">已开票</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="splist_up_01_right">
						...
						<div class="splist_up_01_right_3">
							<a href="?s=order&a=daochu_fapiao" id="daochuA" target="_blank" onclick="daochu();" class="splist_daochu">导 出</a>
						</div>
						<div class="clearBoth"></div>
					</div>
					<div class="clearBoth"></div>
				...
				<div class="splist_up_02">
					...
					<div class="dangqiandd_2_down_3">
						<a href="javascript:" onclick="pi_shenhe();"><img src="images/dangqiandingdan_1.png"> 设置为已开票</a>
			...
			<div class="splist_down1">
				...
				<div class="yuandian_xx" id="operate_row" data-id="0" style="width:100px;">
					<ul>
						<li>
							<a href="javascript:" onclick="kaipiao();"><img src="images/shangchengdd_32.png">已开票</a>
						</li>
						<li id="cancelBtn">
							<a href="javascript:" onclick="bukaipiao();"><img src="images/shangchengdd_25.png">设为不开票</a>
						</li>
					</ul>
				</div>
			</div>
...
<script type="text/javascript" src="js/order/order_fapiao.js"></script>
