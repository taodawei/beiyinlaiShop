...
$allRows = array(
	...
	"type"=>array("title"=>"退款类型","rowCode"=>"{field:'type',title:'退款类型',width:120}"),
...
//计算各类型订单的数量
$zongNum = $db->get_var("select count(*) from order_tuihuan where comId=$comId and status=3");
...
<div id="content">
	<div class="right_up">
		<img src="images/biao_109.png"/> 退款确认<?='('.$zongNum.')'?>
...
<script type="text/javascript">
	...
	layui.use(['laydate', 'laypage','table','form'], function(){
	  ...
	  productListTalbe = table.render({
	    elem: '#product_list'
	    ,height: "full-200"
	    ,url: '?s=order&a=getTuihuanList&type=0'
	    ,page: {curr:<?=$page?>}
	    ,limit:<?=$limit?>
	    ,cols: [[<?=$rowsJS?>]]
	    ,where:{
