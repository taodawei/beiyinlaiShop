...
$levels = $db->get_results("select * from user_level where comId=$comId order by id desc");
?>
<!doctype html>
<html>
<head>
...
<body>
	<div class="yueshezhi">
        <div class="yueshezhi_up">
            <img src="images/mdsz_12.png" alt=""/> 会员等级
        </div>
            ...
            <div class="huiyuandengji_2">
                ...
                <div class="huiyuandengji_2_right">
                    <div class="huiyuandengji_2_right_02">
                        <?// chekurl($arr,'<a href="?m=system&s=mendian_set&a=editLevel">新 增</a>') ?>
                    </div>
                    <div class="clearBoth"></div>
                </div>
                <div class="clearBoth"></div>
                    ...
                    <? if(!empty($levels)){
                        foreach($levels as $l) {
                            ...
                            <tr height="67" id="level_<?=$l->id?>">
                                ...
                                <td bgcolor="#ffffff" class="huiyuandengji_3_line" valign="middle" align="center">
                                    <?=sys_substr($l->content,50,true)?>
                                </td>
                                <td bgcolor="#ffffff" class="huiyuandengji_3_line" valign="middle" align="center">
                                    <? chekurl($arr,'<a href="?m=system&s=mendian_set&a=editLevel&id='.$l->id.'">编辑</a>') ?>
                                    <!--&nbsp; | &nbsp; -->
                                    <?// chekurl($arr,'<a href="javascript:" _href="?m=system&s=mendian_set&a=del_level" onclick="z_confirm(\'确定要删除该级别吗？\',del_level,'.$l->id.');">删除</a>') ?>
                                </td>
                            </tr>
                            <?
                        }
