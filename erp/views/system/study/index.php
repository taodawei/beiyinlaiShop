...
$allRows = array(
	...
	"channel"=>array("title"=>"分类","rowCode"=>"{field:'channel',title:'分类',width:150}"),
...
<body>
	<div class="right_up">
		<img src="images/biao_131.png"/> 学习中心列表
	</div>
					...
					<div class="splist_up_01_right">
						<div class="splist_up_01_right_1">
							<div class="splist_up_01_right_1_left">
								<input type="text" id="keyword" value="<?=$keyword?>" placeholder="请输入学习中心内容标题关键词"/>
							</div>
						...
						<div class="splist_up_01_right_3">
						    <? chekurl($arr,'<a href="?m=system&s=study&a=add" class="splist_add">新 增</a>') ?>
						</div>
						<div class="clearBoth"></div>
					</div>
					<div class="clearBoth"></div>
			...
			<div class="splist_down1">
				...
				<div class="yuandian_xx" id="operate_row" data-id="0">
					<ul>
						...
						<li>
							<a href="javascript:z_confirm('确定要删除该学习资料吗？',del_study,'');"><img src="images/biao_32.png"> 删除</a>
						</li>
					</ul>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		layui.use(['laydate', 'laypage','table','form','upload'], function(){
		  ...
		  productListTalbe = table.render({
		    elem: '#product_list'
		    ,height: "full-140"
		    ,url: '?m=system&s=study&a=getList'
		    ,page: {curr:<?=$page?>}
		    ,limit:<?=$limit?>
		    ,cols: [[<?=$rowsJS?>]]
		    ,where:{
        ...
        function editStudy(){
        	...
        	var url = "?m=system&s=study&channelId="+channelId+"&startTime="+startTime+"&keyword="+keyword+"&endTime="+endTime+"&page="+page+"&order1="+order1+"&order2="+order2;
        	url = encodeURIComponent(url);
        	location.href="?m=system&s=study&a=add&id="+getPdtId()+"&url="+url;
        }
