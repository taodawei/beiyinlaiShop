...
$allRows = array(
				"title"=>array("title"=>"问题名称","rowCode"=>"{field:'title',title:'问题名称',width:200}"),
				...
				"language"=>array("title"=>"语言","rowCode"=>"{field:'language',title:'语言',width:80}"),
...
<body>
	<div class="right_up">
		<img src="images/biao_19.png"/> 技术问题列表
	</div>
     ...
     <!--               </div>-->
					<div class="splist_up_01_right">	
						...
						<div class="splist_up_01_right_3">
						    <? chekurl($arr,'<a href="?&m=system&s=study&a=addFaq" class="splist_add">新 增</a>') ?>
						</div>
						<div class="clearBoth"></div>
					</div>
					<div class="clearBoth"></div>
			...
			<div class="splist_down1">
				...
				<div class="yuandian_xx" id="operate_row" data-id="0">
					<ul>
						<? chekurl($arr,'<li><a href="javascript:" _href="?&m=system&s=study&a=addFaq" onclick="edit_anli()"><img src="images/biao_31.png"> 编辑</a></li>') ?>
						...
						<? chekurl($arr,'<li><a href="javascript:" _href="?&m=system&s=skill&a=del" onclick="z_confirm(\'确定要删除该问题信息吗？\',del_anli,\'\');"><img src="images/biao_32.png"> 删除</a></li>') ?>
					</ul>
				</div>
	...
	<script type="text/javascript">
		...
		layui.use(['laydate', 'laypage','table','form'], function(){
		  ...
		  productListTalbe = table.render({
		    elem: '#product_list'
		    ,height: "full-140"
		    ,url: '?m=system&s=study&a=getFaqList'
		    ,page: {curr:<?=$page?>}
		    ,limit:<?=$limit?>
		    ,cols: [[<?=$rowsJS?>]]
		    ,where:{
		...
		function edit_anli(params){
        	...
        	location.href="?m=system&s=study&a=addFaq&id="+pdtId+"&url="+url;
        }
