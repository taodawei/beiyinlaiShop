...
if($id > 0){
    $gonggao = $db->get_row("select * from demo_study_step where id = $id and is_del = 0 ");
...
<body>
    <div class="right_up">
        <a href="javascript:history.go(-1);"><img src="images/biao_63.png"/></a>实验步骤
    </div>
    <div class="right_down">
        <div class="yx_guanggaoadd">
            <form method="post" action="?m=system&s=study&a=addStep&submit=1&id=<?=$id?>" class="layui-form">
                ...
                <ul>
                    <li>
                        ...
                        <div class="yx_guanggaoadd_01_right">
                            <input type="text" name="title" value="<?=$gonggao->title?>" lay-verify="required" placeholder="请输入步骤标题" class="yx_guanggaoadd_01_right_input"/>
                        </div>
                    ...
                    <li>
                        ...
                        <div class="yx_guanggaoadd_01_right">
                            <input type="text" name="download" value="<?=$gonggao->download?>" lay-verify="required" placeholder="请输入附件链接" class="yx_guanggaoadd_01_right_input"/>
                        </div>
                        <div class="clearBoth"></div>
                    </li>
