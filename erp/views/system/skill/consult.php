...
$allRows = array(
				"name"=>array("title"=>"姓名","rowCode"=>"{field:'name',title:'姓名',width:120}"),
                "channelTitle"=>array("title"=>"咨询服务","rowCode"=>"{field:'channelTitle',title:'咨询服务',width:150}"),
				"email"=>array("title"=>"邮箱","rowCode"=>"{field:'email',title:'邮箱',width:150}"),
				"phone"=>array("title"=>"手机号","rowCode"=>"{field:'phone',title:'手机号',width:120}"),	
				"address"=>array("title"=>"所在省份","rowCode"=>"{field:'address',title:'所在省份',width:150}"),
				"institution"=>array("title"=>"院校/机构","rowCode"=>"{field:'institution',title:'院校/机构',width:150}"),
				
				"dtTime"=>array("title"=>"提交日期","rowCode"=>"{field:'dtTime',title:'提交日期',width:180,sort:true}"),
			);
...
<body>
	<div class="right_up">
		<img src="images/biao_19.png"/>  技术服务咨询列表
	</div>
					...
					<div class="splist_up_01_right">	
						<div class="splist_up_01_right_1">
							<div class="splist_up_01_right_1_left">
								<input type="text" id="keyword" value="<?=$keyword?>" placeholder="请输入姓名/手机号/邮箱/手机号/院校/机构"/>
							</div>
			...
			<div class="splist_down1">
				...
				<div class="yuandian_xx" id="operate_row" data-id="0">
					<ul>
						...
						<? chekurl($arr,'<li><a href="javascript:" _href="?&m=system&s=skill&a=delConsult" onclick="z_confirm(\'确定要删除该服务咨询吗？\',del_anli,\'\');"><img src="images/biao_32.png"> 删除</a></li>') ?>
					</ul>
				</div>
	...
	<script type="text/javascript">
		...
		layui.use(['laydate', 'laypage','table','form'], function(){
		  ...
		  productListTalbe = table.render({
		    elem: '#product_list'
		    ,height: "full-140"
		    ,url: '?m=system&s=skill&a=getConsultList'
		    ,page: {curr:<?=$page?>}
		    ,limit:<?=$limit?>
		    ,cols: [[<?=$rowsJS?>]]
		    ,where:{
        ...
        function del_anli(params){
        	...
        	ajaxpost=$.ajax({
        		type: "POST",
        		url: "?&m=system&s=skill&a=delConsult",
        		data: "&ids="+pdtId,
        		dataType:"json",timeout : 8000,
        		success: function(resdata){
        			if(resdata.code==1){
