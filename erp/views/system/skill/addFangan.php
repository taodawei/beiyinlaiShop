...
<body>
	<form action="?m=system&s=skill&a=addFangan&submit=1&type=<?=$type?>" method="post" id="createPdtForm" class="layui-form" enctype="multipart/form-data">
		...
		<div class="content_edit">
			<div class="edit_h">
				...
				<span>服务: <?=$skill->title?> 添加解决方案</span>
			</div>
			<br>
                ...
                <ul>
                    <li>
                        ...
                        <div class="yx_guanggaoadd_01_right">
                            <input type="text" name="title" value="<?=$banner->title?>" lay-verify="required" placeholder="请输入解决方案标题" class="yx_guanggaoadd_01_right_input"/>
                        </div>
            ...
            thinLine.each(function (i) {
				...
				<div class="edit_miaoshu" style="display:none;">
					<div class="miaoshu_fenlei" id="pdtcontMenu">
						<ul>
							<li><a href="javascript:" id="pdtcontMenu1" onclick="qiehuan('pdtcont',1,'on');" class="on">解决方案描述</a></li>
						</ul>
					</div>
