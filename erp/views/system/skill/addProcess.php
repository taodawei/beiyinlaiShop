...
if($id > 0){
    $banner = $db->get_row("select * from demo_skill_process where id = $id and is_del = 0 ");
    $skillId = $banner->skillId;
...
<body>
	<form action="?m=system&s=skill&a=addProcess&submit=1&type=<?=$type?>" method="post" id="createPdtForm" class="layui-form" enctype="multipart/form-data">
		<input type="hidden" name="url" value="<?=$url?>">
		<input type="hidden" name="id" value="<?=$id?>">
		<input type="hidden" name="skillId" value="<?=$skillId?>">
		<div class="content_edit">
			<div class="edit_h">
				<a href="?m=system&s=skill&a=process&skillId=<?=$skillId?>"><img src="images/back.jpg" /></a>
				<span>服务: <?=$skill->title?> 添加流程</span>
			</div>
			<br>
                ...
                <ul>
                    <li>
                        ...
                        <div class="yx_guanggaoadd_01_right">
                            <input type="text" name="title" value="<?=$banner->title?>" lay-verify="required" placeholder="请输入流程标题" class="yx_guanggaoadd_01_right_input"/>
                        </div>
                    ...
                    <li>
                        ...
                        <div class="yx_guanggaoadd_01_right">
                             <textarea name="jianjie" style="width:654px;height:200px;border: medium dashed black;" class="layui-textarea" placeholder="输入资讯列表的资讯简介"><?=$banner->jianjie?></textarea>
                        </div>
                        <div class="clearBoth"></div>
                    </li>
                    ...
                    <li style="">
                        ...
                        <div class="yx_guanggaoadd_01_right">
                            <a href="<?=$banner->originalPic?>" <? if(empty($banner->originalPic)){?>style="display:none;"<? }?> target="_blank"><img src="<?=$banner->originalPic?>" id="img_zhizhao_img" width="100"></a>
                            <input type="hidden" name="originalPic" value="<?=$banner->originalPic?>" id="img_zhizhao">
                            <button type="button" id="upload2" class="layui-btn">上传</button>
                            <span style="color:#777;margin-left:10px">建议尺寸 60*60 </span>
                        </div>
                        <div class="clearBoth"></div>
                    </li>
		...
		<div class="edit_guige" style="display:none;">
            ...
            thinLine.each(function (i) {
				...
				<div class="edit_miaoshu" style="display:none;">
					<div class="miaoshu_fenlei" id="pdtcontMenu">
						<ul>
							<li><a href="javascript:" id="pdtcontMenu1" onclick="qiehuan('pdtcont',1,'on');" class="on">流程描述</a></li>
						</ul>
					</div>
