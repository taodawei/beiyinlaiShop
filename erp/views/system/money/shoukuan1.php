...
$allRows = array(
				...
				"qrTime"=>array("title"=>"确认时间","rowCode"=>"{field:'qrTime',title:'确认时间',width:150}")
			);
$showRowsArry = array("orderId"=>1,"dtTime"=>1,"kehuName"=>1,"price"=>1,"qrTime"=>1);
...
$zong = $db->get_row("select count(*) as num,sum(price_payed) as money from demo_dinghuo_order where comId=$comId and status>0 and price_weikuan=0");
		...
		<div class="splist">
			<div class="splist_up" style="height:118px;">
				<div class="splist_up_addtab">
	            	<ul>
	            		<li>
	                    	<a href="?m=system&s=money&a=shoukuan" >待收款（<?=$yiqueren?>）</a>
	                    </li>
	                    <li>
	                    	<a href="javascript:" class="splist_up_addtab_on">已收款（<?=$zong->num?>）</a>
	                    </li>
					...
					<div class="splist_up_01_right">
						<div class="splist_up_01_right_3">
							<div class="splist_up_01_right_zj">
                        		已收款合计：<span id="zong_money"><?=$zong->money?></span>
                        	</div>
						</div>
						<div class="clearBoth"></div>
					</div>
			...
			<div class="splist_down1">
				...
				<div class="yuandian_xx" id="operate_row" data-id="0" style="width:100px;">
					<ul>
						<li>
							<a href="javascript:detail_shoukuan('shoukuan1');"><img src="images/biao_30.png"> 收款详情</a>
						</li>
					</ul>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		layui.use(['laydate', 'laypage','table','form'], function(){
		  ...
		  productListTalbe = table.render({
		    elem: '#product_list'
		    ,height: "full-190"
		    ,url: '?m=system&s=money&a=getShoukuanOrder&type=2'
		    ,page: {curr:<?=$page?>}
		    ,limit:<?=$limit?>
		    ,cols: [[<?=$rowsJS?>]]
		    ,where:{
