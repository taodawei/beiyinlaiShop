...
$allRows = array(
				...
				"dtTime"=>array("title"=>"支付时间","rowCode"=>"{field:'dtTime',title:'支付时间',width:150,sort:true}"),
				...
				"pay_type"=>array("title"=>"支付方式","rowCode"=>"{field:'pay_type',title:'支付方式',width:100}"),
				"money"=>array("title"=>"金额","rowCode"=>"{field:'money',title:'金额',width:120}"),
				"account"=>array("title"=>"收款账户","rowCode"=>"{field:'account',title:'收款账户',width:220}"),
				"pay_info"=>array("title"=>"摘要","rowCode"=>"{field:'pay_info',title:'摘要',width:150}")
			);
$showRowsArry = array("orderId"=>1,"dtTime"=>1,"kehuName"=>1,"pay_type"=>1,"money"=>1,"account"=>1,"pay_info"=>1);
					...
					<div class="splist_up_01_right">
						<div class="splist_up_01_right_3">
							<div class="splist_up_01_right_zj">
                        		待确认收款合计：<span id="zong_money"><?=$zong_money?></span>
                        	</div>
						</div>
						<div class="clearBoth"></div>
					</div>
			...
			<div class="splist_down1">
				...
				<div class="yuandian_xx" id="operate_row" data-id="0" style="width:100px;">
					<ul>
						...
						<li>
							<a href="javascript:z_confirm('确定要执行收款确认操作吗？',queren,'');"><img src="images/biao_95.png"> 确认收款</a>
						</li>
						<li>
							<a href="javascript:z_confirm('确定要作废该收款记录吗？',zuofei,'');"><img src="images/biao_32.png"> 作废</a>
						</li>
					</ul>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		layui.use(['laydate', 'laypage','table','form'], function(){
		  ...
		  productListTalbe = table.render({
		    elem: '#product_list'
		    ,height: "full-140"
		    ,url: '?m=system&s=money&a=getShoukuan'
		    ,page: true
		    ,limit:<?=$limit?>
		    ,cols: [[<?=$rowsJS?>]]
		    ,where:{
