...
header("Content-Disposition:attachment; filename=".$storeTitle.'-'.date("Y年m月d日")."-盘点数据.xls");
$allRows = array(
				...
				"code"=>array("title"=>"条形码","rowCode"=>"{field:'code',title:'条形码',width:100}"),
				"untis"=>array("title"=>"单位","rowCode"=>"{field:'untis',title:'单位',width:100}"),
				"shangxian"=>array("title"=>"库存上限","rowCode"=>"{field:'shangxian',title:'库存上限',width:100}"),
				"xiaxian"=>array("title"=>"库存下限","rowCode"=>"{field:'xiaxian',title:'库存下限',width:100}"),
				"kucun"=>array("title"=>"库存数量","rowCode"=>"{field:'kucun',title:'库存数量',width:100}"),
				"pandian"=>array("title"=>"盘点数量","rowCode"=>"{field:'pandian',title:'盘点数量',width:100}"),
