...
$allRows = array(
	"id"=>array("title"=>"团长ID","rowCode"=>"{field:'id',title:'团长ID',width:120}"),
	...
	"earn"=>array("title"=>"总佣金","rowCode"=>"{field:'earn',title:'总佣金',width:150,sort:true}"),
	"xiaji_num"=>array("title"=>"下级人数","rowCode"=>"{field:'xiaji_num',title:'下级人数',width:80}"),
	"team_num"=>array("title"=>"团队人数","rowCode"=>"{field:'team_num',title:'团队人数',width:80}"),
...
<body>
	<div class="right_up">
		<img src="images/biao_m.png"/> 团长列表
	</div>
		...
		<div class="splist">
			<div class="splist_up">
					...
					<div class="splist_up_01_right">	
						<div class="splist_up_01_right_1">
							<div class="splist_up_01_right_1_left">
								<input type="text" id="keyword" value="<?=$keyword?>" placeholder="请输入会员id/姓名/手机号"/>
							</div>
						...
						<!-- <div class="splist_up_01_right_3">
							<a href="?m=system&s=users&a=daochu" id="daochuA" target="_blank" onclick="daochu();" class="splist_daochu">导 出</a>
							<a href="?m=system&s=users&a=daoru" class="splist_daoru">导 入</a>
							<a href="?m=system&s=users&a=create" class="splist_add">新 增</a>
						</div> -->
						<div class="clearBoth"></div>
					</div>
					<div class="clearBoth"></div>
				...
				<!-- <div class="splist_up_02">
					...
					<div class="splist_up_02_3">
						<? 
						$if_lipinka_fafang = $db->get_var("select if_lipinka_fafang from demo_shops where comId=".(int)$_SESSION[TB_PREFIX.'comId']);
						if($if_lipinka_fafang==1){
							?>
							<a href="javascript:" id="setTags" ><img src="images/biao_29.png"/> 发放抵扣金</a>
							<?
						}
						?>
					</div>
			...
			<div class="splist_down1">
				...
				<div class="yuandian_xx" id="operate_row" data-id="0">
					<ul>
						<li>
							<a href="javascript:view();"><img src="images/biao_30.png"> 详情</a>
						</li>
						<li id="operate_jinyong">
							<a href="javascript:z_confirm('禁用后该团长名下的成员都将归属到平台，并且该团长不能再申请成为团长，确定要禁用该团长吗？',jin_user,'');"><img src="images/biao_120.png"> 禁用</a>
						</li>
						<li id="operate_qiyong">
							<a href="javascript:z_confirm('确定要允许该会员重新申请团长吗？',qiyong_user,'');"><img src="images/biao_888.png"> 允许申请</a>
						</li>
					</ul>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		layui.use(['laydate', 'laypage','table','form'], function(){
		  ...
		  productListTalbe = table.render({
		    elem: '#product_list'
		    ,height: "full-140"
		    ,url: '?m=system&s=users&a=getTuanzhangList'
		    ,page: {curr:<?=$page?>}
		    ,limit:<?=$limit?>
		    ,cols: [[<?=$rowsJS?>]]
		    ,where:{
