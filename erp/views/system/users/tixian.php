...
$allRows = array(
    "money"=>array("title"=>"提现金额(元)","rowCode"=>"{field:'money',title:'提现金额(元)',width:150}"),
    "info"=>array("title"=>"账号信息","rowCode"=>"{field:'info',title:'账号信息',width:300}"),
    ...
    "usermoney"=>array("title"=>"账户佣金(元)","rowCode"=>"{field:'usermoney',title:'账户佣金(元)',width:150}"),
    "status"=>array("title"=>"状态","rowCode"=>"{field:'status',title:'状态',width:100}"),
    "shenheName"=>array("title"=>"审批人","rowCode"=>"{field:'shenheName',title:'审批人',width:100}"),
    "shenheTime"=>array("title"=>"审批时间","rowCode"=>"{field:'shenheTime',title:'审批时间',width:150}"),
    "shenheCont"=>array("title"=>"审批意见","rowCode"=>"{field:'shenheCont',title:'审批意见',width:250}")
);
...
<body>
    <div class="mendianguanli"> 
        <div class="mendianguanli_up">
            <img src="images/users_24.png"/> 提现明细
        </div>
                            ...
                            <div class="chongzhimingxi_up_left">
                                <div class="chongzhimingxi_up_left_01">
                                    <div class="chongzhimingxi_up_left_01_left">
                                        <input type="text" id="keyword" placeholder="搜索姓名/账号"/>
                                    </div>
    ...
    <script type="text/javascript">
        ...
        layui.use(['laydate', 'laypage','table','form'], function(){
          ...
          productListTalbe = table.render({
            elem: '#product_list'
            ,height: "full-150"
            ,url: '?m=system&s=users&a=get_tixian_jilu'
            ,page: true
            ,limit:<?=$limit?>
            ,cols: [[<?=$rowsJS?>]]
