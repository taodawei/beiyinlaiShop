...
$allRows = array(
    "jifen"=>array("title"=>"积分变动","rowCode"=>"{field:'jifen',title:'积分变动',width:100}"),
    "yue"=>array("title"=>"积分余额","rowCode"=>"{field:'yue',title:'积分余额',width:150}"),
...
$id = (int)$request['id'];
$user = $db->get_row("select nickname,jifen from users where id=$id and comId=$comId");
                        ...
                        <div class="hyxx_jifenmingxi_up">
                            <div class="hyxx_jifenmingxi_up_left">
                                <div class="hyxx_jifenmingxi_up_left_01">
                                    ...
                                    <div class="hyxx_jifenmingxi_up_left_01_right layui-form">
                                        <select name="type" id="type" lay-filter="type"><option value="">所有</option><option value="1">积分生成</option><option value="2">积分消耗</option></select>
                                    </div>
                            ...
                            <div class="hyxx_jifenmingxi_up_right">
                                当前积分：<span><?=$user->jifen?></span>
                                <a href="?m=system&s=users&a=chongzhi_jifen&id=<?=$id?>" style="color:#369dd0">调整积分</a>
                            </div>
                            <div class="clearBoth"></div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        layui.use(['laydate', 'laypage','table','form'], function(){
          ...
          productListTalbe = table.render({
            elem: '#product_list'
            ,height: "full-240"
            ,url: '?m=system&s=users&a=get_jifen_jilu&userId=<?=$id?>'
            ,page: true
            ,limit:<?=$limit?>
            ,cols: [[<?=$rowsJS?>]]
