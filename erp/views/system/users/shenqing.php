...
$allRows = array(
				...
				"weixin"=>array("title"=>"微信","rowCode"=>"{field:'weixin',title:'微信',width:150}"),
				"shenfenzheng"=>array("title"=>"身份证","rowCode"=>"{field:'shenfenzheng',title:'身份证',width:150}"),
				"user_info"=>array("title"=>"会员信息","rowCode"=>"{field:'user_info',title:'会员信息',width:150}"),
				"area_info"=>array("title"=>"所在地区","rowCode"=>"{field:'area_info',title:'所在地区',width:200}"),
				"title"=>array("title"=>"申请小区","rowCode"=>"{field:'title',title:'申请小区',width:250}"),
				...
				"remark"=>array("title"=>"申请说明","rowCode"=>"{field:'remark',title:'申请说明',width:200}"),
...
<body>
	<div class="right_up">
		<img src="images/biao_94.png"/> 社区申请
	</div>
			...
			<div class="splist_down1">
				...
				<div class="yuandian_xx" id="operate_row" data-id="0">
					<ul>
						...
						<li id="bohui_btn">
							<a href="javascript:" onclick="z_confirm('确定要删除该申请吗？',bohui,'');"><img src="images/shangchengdd_25.png"> 驳回</a>
						</li>
						<li>
	...
	<script type="text/javascript">
		...
		layui.use(['laydate', 'laypage','table','form'], function(){
		  ...
		  productListTalbe = table.render({
		    elem: '#product_list'
		    ,height: "full-140"
		    ,url: '?m=system&s=users&a=getShengqingList'
		    ,page: {curr:<?=$page?>}
		    ,limit:<?=$limit?>
		    ,cols: [[<?=$rowsJS?>]]
		    ,where:{
