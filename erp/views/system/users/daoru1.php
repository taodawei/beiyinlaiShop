			...
			?>
				layer.confirm('无法获取到excel文件数据', {
				  btn: ['确定'],
					...
					location.href='?m=system&s=users&a=daoru';
				});
			<? }?>
		});
		function pandian(){
	...
	<div class="right_down">
    	<div class="kucunpandian">
            	...
            	<div class="kucunpandian_yulan_02">
                	<table width="100%" border="0" cellpadding="0" cellspacing="0">
                    	<tr height="43">
                            ...
                            <td bgcolor="#bcdbea" class="kucunpandian_yulan_02_title" align="center" valign="middle">所属门店</td>
                            <td bgcolor="#bcdbea" class="kucunpandian_yulan_02_title" align="center" valign="middle">性别</td>
                            <td bgcolor="#bcdbea" class="kucunpandian_yulan_02_title" align="center" valign="middle">出生日期</td>
                        </tr>
                        <?
                        if($confirm==1){
	                        for($i=0;$i<$num;$i++) {
        	...
        	<div class="kucunpandian_03">
        		<? if($confirm==1){?>
        		<form id="pandianForm" action="?s=users&a=daoru2" method="post">
