...
$allRows = array(
    "title"=>array("title"=>"商品名称","rowCode"=>"{field:'title',title:'商品名称',width:300}"),
    "sn"=>array("title"=>"商品编号","rowCode"=>"{field:'sn',title:'赠品编号',width:100}"),
    "key_vals"=>array("title"=>"商品规格","rowCode"=>"{field:'key_vals',title:'商品规格',width:200}"),
                ...
                <div class="huiyuanxinxi_down">
                    <div class="hyxx_guanzhudongtai">
                        <div class="hyxx_guanzhudongtai_up">
                            <ul>
                                <li>
                                    <a href="javascript:" class="hyxx_guanzhudongtai_up_on">商品关注 <span>( <?=$pdt_collect_num?> )</span></a>
                                </li>
                                <li>
                                    <a href="?m=system&s=users&a=guanzhu_shop&id=<?=$request['id']?>&returnurl=<?=urlencode($request['returnurl'])?>">店铺关注 <span>( <?=$shop_collect_num?> )</span></a>
                                </li>
                                <li>
    ...
    <script type="text/javascript">
        ...
        layui.use(['laydate', 'laypage','table','form'], function(){
          ...
          productListTalbe = table.render({
            elem: '#product_list'
            ,height: "full-265"
            ,url: '?m=system&s=users&a=get_pdt_collect&userId=<?=$id?>'
            ,page: {curr:<?=$page?>}
            ,limit:<?=$limit?>
            ,cols: [[<?=$rowsJS?>]]
