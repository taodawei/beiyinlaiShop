...
$allRows = array(
    "card_no"=>array("title"=>"储值卡号","rowCode"=>"{field:'card_no',title:'储值卡号',width:200}"),
    "earn"=>array("title"=>"初始金额","rowCode"=>"{field:'earn',title:'初始金额',width:350}"),
    "yue"=>array("title"=>"金额(元)","rowCode"=>"{field:'yue',title:'金额(元)',width:100}"),
    ...
    <script type="text/javascript">
        ...
        layui.use(['laydate', 'laypage','table','form'], function(){
          ...
          productListTalbe = table.render({
            elem: '#product_list'
            ,height: "full-270"
            ,url: '?m=system&s=users&a=getCardList&userId=<?=$id?>'
            ,page: true
            ,limit:<?=$limit?>
            ,cols: [[<?=$rowsJS?>]]
