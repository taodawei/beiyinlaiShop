...
$caiwu = array();
if(!empty($id)){
    $kehu = $db->get_row("select * from demo_salesman where id=$id");
...
<body>
	<div class="back1">
        ...
        <div><? if(empty($kehu)){?>添加<? }else{ echo '修改';}?>销售人员</div>
    </div>
    <div class="cont" style="height:100%">
        <form action="?s=users&a=add_salesman&tijiao=1&id=<?=$id?>" method="post" id="submitForm" class="layui-form">
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td class="provider_td" width="50%">
                            ...
                            <div class="cont_left_input1">
                                <input name="name" id="title" class="layui-input" lay-verify="required" type="text" value="<?=$kehu->name?>" placeholder="请输入姓名" />
                            </div>
                            <div class="clearBoth"></div>
                        </td>
                        <td class="provider_td" valign="top">
                            <div class="cont_left_tt">
                                 <span class="must">*</span>所属区域
                            </div>
                            <div class="cont_left_input1">
                                <input name="area" class="layui-input" lay-verify="required" type="text" value="<?=$kehu->area?>" placeholder="请输入销售区域"/>
                            </div>
                            <div class="clearBoth"></div>
                        </td>
                    </tr>
                    <tr>
                        <td class="provider_td" width="50%">
                            ...
                            <div class="cont_left_input1">
                                <input name="email" class="layui-input" lay-verify="required" type="text" value="<?=$kehu->email?>" placeholder="联系人邮箱"/>
                            </div>
                            <div class="clearBoth"></div>
                        </td>
                        <td class="provider_td" width="50%">
                            ...
                            <div class="cont_left_input1">
                                <input name="phone" class="layui-input" type="text" lay-verify="required" value="<?=$kehu->phone?>" placeholder="请输入联系电话"/>
                            </div>
                            <div class="clearBoth"></div>
                        </td>
                    </tr>
                    <tr style="display:none;">
                        <td class="provider_td" width="50%">
                            ...
                            <div class="cont_left_input1">
                                <input name="ordering" class="layui-input" lay-verify="required" type="number" min="0" step="1" value="<?=$kehu->ordering?>" placeholder="排序"/>
                            </div>
                            <div class="clearBoth"></div>
                        </td>
                        ...
                        <!--    </div>-->
                        <!--    <div class="cont_left_input1">-->
                        <!--        <input name="userId" class="layui-input" lay-verify="required|number" type="text" value="<?=$kehu->userId?>" placeholder="销售人员会员ID/手机号" onchange="get_user_info(this.value,<?=$id?>);" style="width:140px;display:inline-block;"/>-->
