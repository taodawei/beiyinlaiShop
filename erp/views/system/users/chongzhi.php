                    ...
                    <form method="post" id="chongzhiForm" action="?m=system&s=users&a=chongzhi" class="layui-form">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <button class="layui-btn layui-btn-primary" onclick="history.back(-1);return false;">取 消</button>
                            </li>
                        </ul>
                    </form>
                </div>
    ...
    <script type="text/javascript">
        layui.use(['form'], function(){
            ...
            form.on('submit(tijiao)', function(data){
                ...
                $.ajax({
                    type: "POST",
                    url: '?m=system&s=users&a=chongzhi&submit=1',
                    data: data.field,
        ...
        function getKehuList(keyword){
            ...
            $.ajax({
                type: "POST",
                url: "?m=system&s=users&a=searchUsers",
