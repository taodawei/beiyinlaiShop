...
$card = $db->get_row("select * from user_card where id = $cardId");
...
<body>
    <div class="mendianguanli"> 
        <div class="mendianguanli_up">
            <a href="?m=system&s=users&a=card&id=<?=$card->userId?>"><img src="images/users_39.png"></a> <b style="color:#369dd0;"><?=$user->nickname?></b> 储值卡详情
        </div>
            ...
            <div class="huiyuanxinxi">
                ...
                <div class="huiyuanxinxi_down">
                    <div class="hyxx_yuemingxi_up">
                        <ul>
                            <li style="background-color:#77a9da;" onclick="select_type(0);"  onmouseleave="hideTips();">
                                <div class="hyxx_yuemingxi_up_left">
                                    <h2>¥<?=$card->card_no?></h2>卡号
                                </div>
                            ...
                            <li style="background-color:#7acad1;" onclick="select_type(0);"  onmouseleave="hideTips();">
                                <div class="hyxx_yuemingxi_up_left">
                                    <h2>¥ <?=$card->yue?></h2>余额金额
                                </div>
                                <div class="clearBoth"></div>
                            </li>
                            <li style="background-color:#b19ecb;display:none;" onclick="select_type(1);" onmouseenter="tips(this,'点击查看所有消费记录',1);" onmouseleave="hideTips();">
                                <div class="hyxx_yuemingxi_up_left">
    ...
    <script type="text/javascript">
        ...
        layui.use(['laydate', 'laypage','table','form'], function(){
          ...
          productListTalbe = table.render({
            elem: '#product_list'
            ,height: "full-340"
            ,url: '?m=system&s=users&a=get_liushui_jilu&userId=<?=$id?>&source=2&cardId=<?=$cardId?>'
            ,page: true
            ,limit:<?=$limit?>
            ,cols: [[<?=$rowsJS?>]]
