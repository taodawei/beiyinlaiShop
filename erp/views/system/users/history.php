...
$allRows = array(
	"month"=>array("title"=>"月份","rowCode"=>"{field:'month',title:'月份',width:150}"),
// 	"userInfo"=>array("title"=>"用户信息","rowCode"=>"{field:'userInfo',title:'用户信息',width:200,style:\"height:auto;line-height:22px;white-space:normal;\"}"),
	...
	"total_fenhong"=>array("title"=>"本月总佣金","rowCode"=>"{field:'total_fenhong',title:'本期总佣金',width:100}"),
);
...
<body>
	<div class="right_up">
		<img src="images/biao_19.png"/> 往期总览统计
	</div>
		...
		<div class="splist">
			<div class="splist_up">
				<div class="splist_up_01">
					...
					<div class="splist_up_01_right" style="display:none;">	
	...
	<script type="text/javascript">
		...
		layui.use(['laydate', 'laypage','table','form'], function(){
		  ...
		  productListTalbe = table.render({
		    elem: '#product_list'
		    ,height: "full-140"
		    ,url: '?s=users&a=getHistoryList&userId=<?=$userId?>'
		    ,page: {curr:<?=$page?>}
		    ,limit:<?=$limit?>
		    ,cols: [[<?=$rowsJS?>]]
		    ,autoSort:false
