...
$gift_cards = $db->get_results("select * from gift_card$fenbiao where comId=$comId and userId=$userId and (endTime is NULL or endTime>='".date("Y-m-d")."') and yue>0 order by id desc");
?>
...
<div class="wdlipinka_2" onclick="location.href='/index.php?p=8&a=lipinka3'">
    <div class="wdlipinka_2_left">
        <img src="/skins/lipinka/images/wodelipinka_12.png"/> 已用完/已过期的抵扣金
    </div>
