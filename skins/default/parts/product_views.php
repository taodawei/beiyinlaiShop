...
<div id="chanpin">
        ...
        <div class="chanpin_2">
            ...
            <? if(empty($yushou)){?>
                <div class="chanpin_2_04">  
                   <? echo $db->get_var("select jifen from demo_jifenList where inventoryId=".$product_inventory->id." limit 1")?>积分
                </div>
            <? }else{
                ?>
            ...
            <div class="pintuanxx_3">
                ...
                <div class="pintuanxx_3_down">
                    <ul>
                        ...
                        $tuangou = $tuangous[0];
                        if(!empty($tuangou)){
                            $u = $db->get_row("select name,image from users where id=$tuangou->tuanzhang");
                            ?>
                            <li>
                                <div class="pintuanxx_3_down_1">
                                    <img src="<?=ispic($u->image)?>"/> <?=$u->name?>
                                </div>
    ...
    <div class="chanpin_9">
        ...
        <div class="chanpin_9_right">
            <ul>
                <li style="width:100%">
                        <a href="javascript:" onclick="show_buy_div(1,1);" class="chanpin_9_right_01">立即兑换</a>
                </li>
                <div class="clearBoth"></div>
            </ul>
        </div>
...
<div class="cp_lijigoumai_tc" id="cp_lijigoumai_tc" style="display:none;">
    ...
    <div class="cp_lijigoumai">
        ...
        <div class="cp_lijigoumai_2">
            ...
            <div class="cp_lijigoumai_2_right">
                <div class="cp_lijigoumai_2_right_1">
                    <b id="price_sale"><? echo $db->get_var("select jifen from demo_jifenList where inventoryId=".$product_inventory->id." limit 1")?></b>积分
                </div>
        ...
        <div class="cp_lijigoumai_5" id="liji_div">
            <a href="javascript:" onclick="buys(3);" style="background-color: #ff2700;border-radius:5px;width:100%;height:2.175rem;display:block;text-align:center;line-height:2.175rem;font-size:.6rem;color:#fff;" class="chanpin_9_right_01">立即兑换</a>
        </div>
        <div class="pintuanxx_kaituan_5" id="kaituan_div" style="display:none;">
            <ul>
                <li style="background-color:#f61a08;width:96%;margin-left:2%;">
                    <a href="javascript:" onclick="kaituan();">立即开团</a>
                </li>
                <div class="clearBoth"></div>
            </ul>
        </div>
...
<script type="text/javascript">
    ...
    function buys(addType){
        ...
        $.ajax({
            type: "POST",
            url: "/index.php?p=4&a=add_gouwuches&addType="+addType,
            ...
            success: function(resdata){
                ...
                location.href='/index.php?p=4&a=querens';
            },
            error: function() {
