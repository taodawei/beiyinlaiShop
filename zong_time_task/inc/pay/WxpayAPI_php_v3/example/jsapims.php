...
$body = mb_substr($body,0,40,"utf-8");
$subject = mb_substr($subject,0,40,"utf-8");
...
$baseUrl = "http://".$_SERVER['HTTP_HOST']."/notifyms.php";
//②、统一下单
...
//$input->SetNotify_url('http://ez.qwalipay.com/');
$input->SetNotify_url("http://".$_SERVER['HTTP_HOST']."/notifyms.php");
 ...
 */
$url = '/index.php?f=userCenter&a=order';
...
<script src="/skins/wap/scripts/jquery-1.11.2.min.js" type="text/javascript"></script>
<title>微信支付</title>
		...
		WeixinJSBridge.invoke(
			...
			function(res){
				...
				if(res.err_msg == 'get_brand_wcpay_request:ok'){
					location.href='/index.php?f=userCenter&a=order';
				}else{
					alert(res.err_msg);
...
<div id="pintuanzutuan">
    <div class="pintuanxiangqing_1">
        ...
        <div class="pintuanxiangqing_1_02" onclick="location.href='/index.php?f=userCenter&a=order';">
            <img src="/skins/wap/images/biao_20.png"/>
        </div>
        <div class="pintuanxiangqing_1_03" onclick="location.href='/index.php?f=userCenter&a=order';">   
                关闭
        </div>
    </div>
