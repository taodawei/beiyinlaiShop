...
$subject = "账户充值";
$price   = $orders->money;
$body    = "账户充值:".$orders->money;


$pay_price = ($orders->money)*100;

$dtTime = date("YmdHis",strtotime($orders->dtTime));
$expireTime = date("YmdHis", time() + 60*60*24);

$baseUrl = "http://".$_SERVER['HTTP_HOST']."/notifycz.php";
//②、统一下单
...
$input->SetNotify_url("http://".$_SERVER['HTTP_HOST']."/notifycz.php");
...
<div id="pintuanzutuan">
    <div class="pintuanxiangqing_1">
        ...
        <div class="pintuanxiangqing_1_02" onclick="location.href='/userCenter/order.html';">
            <img src="/skins/wap/images/biao_20.png"/>
        </div>
        <div class="pintuanxiangqing_1_03" onclick="location.href='/userCenter/order.html';">   
                关闭
        </div>
    </div>
