...
require_once "../inc/pay/WxpayAPI_php_v3/lib/WxPay.Exception.php";
require_once "../inc/pay/WxpayAPI_php_v3/lib/WxPay.Config1h.php";
require_once "../inc/pay/WxpayAPI_php_v3/lib/WxPay.Data1h.php";
...
class WxPayApi
{
	...
	{		
		...
		curl_setopt($ch,CURLOPT_SSL_VERIFYPEER,FALSE);//原：curl_setopt($ch,CURLOPT_SSL_VERIFYPEER,TRUE);
		curl_setopt($ch,CURLOPT_SSL_VERIFYHOST,FALSE);//严格校验2 //原：curl_setopt($ch,CURLOPT_SSL_VERIFYHOST,2);//严格校验
		//设置header
