...
// --------------------------------------------------------------------------------
  ...
  define( 'PCLZIP_OPT_BY_@ereg', 77010 );
...
//    $p_header['external'] = (is_file($p_filename)?0xFE49FFE0:0x41FF0010);
  ...
  function privExtractByRule(&$p_file_list, $p_path, $p_remove_path, $p_remove_all_path, &$p_options)
  {
    ...
    for ($i=0, $v_nb_extracted=0; $i<$v_central_dir['entries']; $i++)
    {
      ...
      else if (   (isset($p_options[PCLZIP_OPT_BY_@ereg]))
               && ($p_options[PCLZIP_OPT_BY_@ereg] != "")) {
          //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 3, "Extract by @ereg '".$p_options[PCLZIP_OPT_BY_@ereg]."'");

          if (@ereg($p_options[PCLZIP_OPT_BY_@ereg], $v_header['stored_filename'])) {
      ...
      // ----- Look for extract by preg rule
          ...
          //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 3, "Extract with rule 'By@ereg'");
  ...
  function privDeleteByRule(&$p_result_list, &$p_options)
  {
    ...
    for ($i=0, $v_nb_extracted=0; $i<$v_central_dir['entries']; $i++)
    {
      ...
      // ----- Look for extract by @ereg rule
          ...
          if (@ereg($p_options[PCLZIP_OPT_BY_@ereg], $v_header_list[$v_nb_extracted]['stored_filename'])) {
              //--(MAGIC-PclTrace)--//PclTraceFctMessage(__FILE__, __LINE__, 3, "Filename match the regular expression");
              $v_found = true;
          }
      }
